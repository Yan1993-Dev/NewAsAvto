...
<main>
            ...
            <div class="slider-container">
                <div class="swiper-container__title">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/35white.png" src="#" alt=""></div>
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/35brown.png" alt=""></div>
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/35red.png" alt=""></div>
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/35grey.png" alt=""></div>
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/35blue.png" alt=""></div>
                    </div>
                    <div class="swiper_pagination">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/35white.svg" alt="" class="slider_img_title">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/35brown.svg" alt="" class="slider_img_title">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/35red.svg" alt="" class="slider_img_title">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/35grey.svg" alt="" class="slider_img_title">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/35blue.svg" alt="" class="slider_img_title">
                    </div>
                </div>
            </div>
        </div>
        <div class="form_wrapper">
            <section class="form_traid-in">
                ...
                <form class="form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
                    ...
                    <input type="hidden" name="SUBJECT" value=" Заявка на Trade-in Changan 35*">
                ...
                <form class="form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
                    ...
                    <div class="field__wrapper">
                        ...
                        <div class="field">
                            ...
                            <input type="text" id="input__initial" name="td-model" class="input__traid-in" placeholder="Сумма первого взноса">
                        </div>
                        <div class="field">
                            <label for="credit__time" class="label__traid-in">Срок</label>
                            <input type="text" id="credit__time" name="select-model" class="input__traid-in" placeholder="Срок кредита">
                        </div>
                    </div>
                    <div class="checkbox_popup">
                        Нажимая кнопку «Отправить», вы даете Согласие на обработку персональных данных
                    ...
                    <input type="hidden" name="url" value="<?= $_SERVER['REQUEST_URI'] ?>">
                    <input type="hidden" name="SUBJECT" value=" Заявка на Кредит Changan 35*">
                    <div class="popup__btn__flex">
    ...
    <div class="container_site">
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/35__technologies.php"
            )
        ); ?>
    </div>
    <div class="container_site">
        ...
        <table class="fold-table">
            ...
            <tbody>
                <tr class="view">
                    ...
                    <td class="pcs equipment_item_old_price">1 959 900 руб.</td>
                    <td class="cur equipment_item_new_price">1 899 900 руб.</td>
                        ...
                        <div class="fold-content">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Наружные зеркала заднего вида окрашенные в цвет кузова с интегрированными светодиодными указателями поворота</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Легкосплавные колёсные диски 16х6,5J. Шины 215/60 R16</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Механическая регулировка положения руля по высоте</td>
                                    </tr>
                                    <tr>
                                        <td>Внутрисалонное зеркало заднего вида с антибликовым покрытием</td>
                                    </tr>
                                    <tr>
                                        <td>Хромированные ручки открывания дверей</td>
                                    </tr>
                                    <tr>
                                        <td>Мягкая обивка панели приборов с металлическими вставками, отделка строчкой</td>
                                    </tr>
                                    <tr>
                                        <td>Мягкая комбинированная отделка дверей с искусственной кожей и металлическими вставками</td>
                                    </tr>
                                    <tr>
                                        <td>Эргономичное сиденье водителя с боковой поддержкой, продольной регулировкой, регулировкой по высоте и наклону спинки</td>
                                    </tr>
                                    <tr>
                                        <td>Эргономичное сиденье пассажира с боковой поддержкой, продольной регулировкой и регулировкой угла наклона спинки</td>
                                    </tr>
                                    <tr>
                                        <td>Индивидуальные зеркала в солнцезащитных козырьках</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Отсек для хранения очков, интегрированный в потолочную панель</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Механизм складывания задних сидений (в пропорции 60/40)</td>
                                    </tr>
                                    <tr>
                                        <td>Два подголовника сзади с механизмом травмобезопасного демпфирования</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Система ЭРА ГЛОНАСС</td>
                                    </tr>
                                    <tr>
                                        <td>Электронная система стабилизации (ESP)</td>
                                    </tr>
                                    <tr>
                                        <td>Антиблокировочная система (ABS)</td>
                                    </tr>
                                    <tr>
                                        <td>Электронной система распределения тормозных усилий (EBD)</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Система контроля давления в шинах (TMPS)</td>
                                    </tr>
                                    <tr>
                                        <td>Передние подушки безопасности</td>
                                    </tr>
                                    <tr>
                                        <td>Энергопоглащающая рулевая колонка</td>
                                    </tr>
                                    <tr>
                                        <td>3-х точечные ремни безопасности для всех пассажиров</td>
                                    </tr>
                                    <tr>
                                        <td>Регулировка положения ремня безопасности по высоте для водителя и переднего пассажира</td>
                                    </tr>
                                    <tr>
                                        <td>Крепления ISOFIX для установки детского сиденья сзади</td>
                                    </tr>
                                    <tr>
                                        <td>Система предупреждения водителей сзади при экстренном торможении (двойная вспышка)</td>
                                    </tr>
                                    <tr>
                                        <td>Ассистент управления головным светом в зависимости от уровня освещённости</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Эргономичное многофункциональное рулевое колесо с возможностью управления развлекательным центром и телефоном</td>
                                    </tr>
                                    <tr>
                                        <td>Сенсорный 10,25 дюймовый дисплей управления мультимедийным развлекательным центром</td>
                                    </tr>
                                    <tr>
                                        <td>Бортовой компьютер с многофункциональным 4-х дюймовым цветным дисплеем на приборной панели</td>
                                    </tr>
                                    <tr>
                                        <td>4 динамика</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Возможность подключения мобильного телефона и мультимедиа устройств по интерфейсу Bluetooth</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Передние стеклоочистители с плавным изменением скорости работы</td>
                                    </tr>
                                    <tr>
                                        <td>Многофункциональный USB порт для передних пассажиров</td>
                                    </tr>
                                    <tr>
                                        <td>Штатный USB разъём для установки видеорегистратора</td>
                                    </tr>
                                    <tr>
                                        <td>USB порт для задних пассажиров, с возможностью зарядки мобильных устройств</td>
                                    </tr>
                                    <tr>
                                        <td>Электромеханический замок багажного отделения</td>
                                    </tr>
                                    <tr>
                                        <td>Пластиковая защита двигателя</td>
                                    </tr>
                                    <tr>
                                        <td>Шумо- и теплоизоляция моторного отсека</td>
                                    </tr>
                                    <tr>
                                        <td>Антигрязевая защита порогов спереди и сзади</td>
                                    </tr>
                                    <tr>
                ...
                <tr class="view">
        <td>1.6 MT Luxe</td>
        <td class="pcs equipment_item_old_price">2 019 900 руб.</td>
        <td class="cur equipment_item_new_price">1 959 900 руб</td>
        <td>в кредит за 11 990 руб/мес <br> или меньше!</td>
        <td class="per"><a class="equipment_item_credit_btn btn" href="#calculator">Рассчитать кредит</a></td>
    </tr>
    <tr class="fold">
        <td colspan="7">
            <div class="fold-content">
                <p class="save_title_additionally">В дополнение к комплектации 1.6 MT Comfort:</p>
                <table>
                    <tbody>
                        <tr>
                            <td class="save_title">Экстерьер</td>
                        ...
                        <tr>
                            <td>Хромированная окантовка боковых окон</td>
                        </tr>
                        <tr>
                            <td>Легкосплавные колёсные диски 17х7,0J. Шины 215/55 R17</td>
                        </tr>
                    </tbody>
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            <td>Комбинированная отделка сидений искусственной кожей, отделка строчкой</td>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Электроскладываемые наружные зеркала заднего вида с электрорегулировкой и подогревом</td>
                        </tr>
                        <tr>
                            <td>Регулировка громкости мультемедийной системы для переднего пассажира</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <tr class="view">
                    <td>1.6 AT Comfort</td>
                    <td class="pcs equipment_item_old_price">2 069 900 руб.</td>
                    <td class="cur equipment_item_new_price">2 009 900 руб</td>
                    <td>в кредит за 11 990 руб/мес <br> или меньше!</td>
                    <td class="per"><a class="equipment_item_credit_btn btn" href="#calculator">Рассчитать кредит</a></td>
                </tr>
                <tr class="fold">
                    <td colspan="7">
                        <div class="fold-content">
                            <p class="save_title_additionally">В дополнение к комплектации 1.6 MT Luxe:</p>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="save_title">Интерьер</td>
                                    ...
                                    <tr>
                                        <td>Механическая регулировка положения руля по высоте и по вылету</td>
                                    </tr>
                                    <tr>
                                        <td>Отделка кожей рукоятки рычага переключения передач</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Эргономичное многофункциональное рулевое колесо с возможностью управления развлекательным центром, телефоном и круиз-контролем</td>
                                    </tr>
                                    <tr>
                                        <td>Круиз-контроль</td>
                                    </tr>
                                    <tr>
                                        <td>Климат-контроль с сенсорным управлением c функцией ионизации воздуха (Air Forest)</td>
                                    </tr>
                                    <tr>
                                        <td>Интеллектуальный (SMART) ключ с возможностью индивидуального программирования
                                            пользовательских настроек с функциями поиска автомобиля на парковке, дистанционного
                                            запуска двигателя и дистанционным управлением</td>
                                    </tr>
                                    <tr>
                                        <td>Системы бесключевого доступа и запуска двигателя PEPS (passive entry passive start)</td>
                                    </tr>
                                    <tr>
                                        <td>Ассистент парковки с задними датчиками, отображением дистанции до препятствия
                                            и звуковым информированием</td>
                                    </tr>
                                    <tr>
                                        <td>Электромеханический стояночный тормоз</td>
                                    </tr>
                                    <tr>
                                        <td>Декоративная накладка на двигатель</td>
                                    </tr>
                                    <tr>
    ...
    <tr class="view">
        <td>1.6 AT Luxe</td>
        <td class="pcs equipment_item_old_price">2 129 900 руб.</td>
        <td class="cur equipment_item_new_price">2 069 900 руб</td>
        <td>в кредит за 11 990 руб/мес <br> или меньше!</td>
        <td class="per"><a class="equipment_item_credit_btn btn" href="#calculator">Рассчитать кредит</a></td>
    </tr>
    <tr class="fold">
        <td colspan="7">
            <div class="fold-content">
                <p class="save_title_additionally">В дополнение к комплектации 1.6 AT Comfort:</p>
                <table>
                    <tbody>
                        <tr>
                            <td class="save_title">Интерьер</td>
                        ...
                        <tr>
                            <td>Эргономичное сиденье водителя с боковой поддержкой и электрорегулировками:
в продольном направлении, по высоте и наклону спинки</td>
                        </tr>
                        <tr>
                            <td>Отделка кожей рукоятки рычага переключения передач</td>
                        </tr>
                        <tr>
                            <td>Индивидуальная светодиодная подсветка для пассажиров переднего и заднего рядов</td>
                        </tr>
                    </tbody>
                    <tbody>
                        <tr>
    ...
    <div class="popup__container">
        <form class="form title__popup__js  title__popup" id="popup__form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
            ...
            <input type="hidden" name="url" value="<?= $_SERVER['REQUEST_URI'] ?>">
            <input type="hidden" name="SUBJECT" value=" Заявка на Тест-драйв CS35PLUS*">
