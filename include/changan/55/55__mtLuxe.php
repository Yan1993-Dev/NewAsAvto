<li class="accordion">
    ...
    <span class="accordion__title">
        <ul class="equipment_title_two">
            ...
            <div class="compl">
                ...
                <li class="equipment_item_model">1.5T MT LUXE</li>
            </div>
            <div class="compl">
    ...
    <h3 class="design_title">ЭКСТЕРЬЕР</h3>
        <ul class="design">
            <li class="design_item">Ассистент управления головным светом в зависимости от уровня освещенности</li>
        </ul>
        <h3 class="design_title">ИНТЕРЬЕР</h3>
        <ul class="design">
            <li class="design_item">Комбинированная отделка сидений искусственной кожей</li>
        </ul>
        ...
        <ul class="save">
            ...
            <li class="save_item">Электростеклоподъёмники передних и задних дверей с функцией комфортного управления
            </li>
