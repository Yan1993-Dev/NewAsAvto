...
<main>
        ...
        <div class="form_wrapper">
            <section class="form_traid-in">
                ...
                <form class="form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
                    ...
                    <input type="hidden" name="SUBJECT" value=" Заявка на Кредит Changan 75*">
    ...
    <div class="container_site">
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/75__technologies.php"
            )
        ); ?>
    </div>
    <div class="container_site">
    ...
    <div class="container_complictation">
        <table class="fold-table">
            ...
            <tbody>
                <tr class="view">
                    <td>1,8T AT 2WD Comfort</td>
                    <td class="pcs equipment_item_old_price">2 369 900 руб.</td>
                        ...
                        <div class="fold-content">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Эргономичное многофункциональное рулевое колесо с отделкой искусственной кожей, возможностью управления развлекательным центром и устройствами, подключенными по Bluetooth</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Складной ключ с функцией дистанционного управления</td>
                                    </tr>
                                    <tr>
                                        <td>Система контроля давления воздуха в шинах (TPMS)</td>
                                    </tr>
                                    <tr>
                                        <td>Бортовой компьютер с многофункциональным 7-ми дюймовым цветным дисплеем на приборной панели</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Электромеханический стояночный тормоз с функцией автоматического удержания (AUTO HOLD)</td>
                                    </tr>
                                    <tr>
                                        <td>Кондиционер</td>
                                    </tr>
                                    <tr>
                                        <td>Воздуховоды для задних пассажиров</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Электростеклоподъёмники передних и задних дверей с функцией автоматического открывания окна двери водителя</td>
                                    </tr>
                                    <tr>
                                        <td>Газовые упоры капота</td>
                                    </tr>
                                    <tr>
                                        <td>Сенсорный 10,25 дюймовый дисплей мультимедийного развлекательного центра</td>
                                    </tr>
                                    <tr>
                                        <td>Акустическая система Hi-End с 8 динамиками</td>
                                    </tr>
                                    <tr>
                                        <td>Возможность подключения мобильного телефона и мультимедиа устройств по протоколу Bluetooth</td>
                                    </tr>
                                    <tr>
                                        <td>Многофункциональный USB порт для передних пассажиров и USB розетка для пассажиров второго ряда</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>3-х точечный ремень безопасности водителя и переднего пассажира</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Центральный замок с функцией автоматической блокировки при движении и разблокировки при парковке</td>
                                    </tr>
                                    <tr>
                                        <td>Система ISOFIX для крепления детского удерживающего устройства на сиденье второго ряда</td>
                                    </tr>
                                    <tr>
                                        <td>Электромеханический замок багажного отделения с возможностью аварийного отпирания</td>
                                    </tr>
                                    <tr>
                                        <td>Иммобилайзер</td>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Светодиодные фары головного света "PURE VISION" с функцией регулировки по высоте</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Комбинированные задние LED фонари</td>
                                    </tr>
                                    <tr>
                                        <td>Задние противотуманные фонари</td>
                                    </tr>
                                    <tr>
                                        <td>Подсветка заднего хода и заднего номерного знака</td>
                                    </tr>
                                    <tr>
                                        <td>Спойлер 5-й двери со светодиодным повторителем стоп-сигнала</td>
                                    </tr>
                                    <tr>
                                        <td>Легкосплавные колёсные диски оригинального дизайна 17х7J, двухцветные. Шины 225/65 R17</td>
                                    </tr>
                                    <tr>
                                        <td>Аварийное запасное колесо</td>
                                    </tr>
                                    <tr>
                                        <td>Продольные рейлинги на крыше</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Хромированная отделка окон, проема багажного отделения и наружных ручек. Декоративные элементы на дверях и капоте</td>
                                    </tr>
                                    <tr>
                                        <td>Разнесенная по сторонам выхлопная труба с хромированными накладками</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Отделка дверей и сидений искусственной кожей с контрастной строчкой</td>
                                    </tr>
                                    <tr>
                                        <td>Эргономичное сиденье водителя с боковой поддержкой и механической регулировкой в 6-ти направлениях</td>
                                    </tr>
                                    <tr>
                                        <td>Эргономичное сиденье переднего пассажира с боковой поддержкой и механической регулировкой в 4-х направлениях</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Передний подлокотник с отделением для хранения и функцией охлаждения</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Подголовники сидений с функцией регулировки по высоте</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Индивидуальная подсветка для пассажиров переднего и заднего ряда</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <tr class="view">
                    <td>1,8T AT 2WD Luxury</td>
                    <td class="pcs equipment_item_old_price">2 469 900 руб.</td>
                    <td class="cur equipment_item_new_price">2 409 900 руб</td>
                    <td>в кредит за 11 990 руб/мес <br> или меньше!</td>
                    <td class="per"><a class="equipment_item_credit_btn btn" href="#calculator">Рассчитать кредит</a></td>
                </tr>
                <tr class="fold">
                        ...
                        <div class="fold-content">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Интеллектуальный (SMART) ключ с функциями дистанционного управления и комфортного доступа</td>
                                    </tr>
                                    <tr>
                                        <td>Система бесключевого доступа со стороны водителя и переднего пассажира</td>
                                    </tr>
                                    <tr>
                                        <td>Система бесключевого запуска двигателя с кнопки (START STOP)</td>
                                    </tr>
                                    <tr>
                                        <td>Система помощи при парковке с отображением расстояния до объекта и звуковым информированием (4-ре датчика в заднем бампере)</td>
                                    </tr>
                                    <tr>
                                        <td>Камера заднего вида с динамической разметкой</td>
                                    </tr>
                                    <tr>
                                        <td>Круиз-контроль с управлением на рулевом колесе</td>
                                    </tr>
                                    <tr>
                                        <td>Климат-контроль</td>
                                    </tr>
                                    <tr>
                                        <td>Электростеклоподъёмники передних и задних дверей с функцией автоматического открывания и закрывания окна двери водителя</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Светодиодные передние противотуманные фары</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Эргономичное сиденье водителя с боковой поддержкой и электрической регулировкой в 6-ти направлениях</td>
                                    </tr>
                                    <tr>
                                        <td>Подогрев сиденья водителя и переднего пассажира</td>
                                    </tr>
                                    <tr>
                                        <td>Атмосферная подсветка салона (одноцветная)</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <tr class="view">
        <td>1,8T AT 4WD Comfort</td>
        <td class="pcs equipment_item_old_price">2 589 900 руб.</td>
        <td class="cur equipment_item_new_price">2 529 900 руб</td>
        <td>в кредит за 11 990 руб/мес <br> или меньше!</td>
        <td class="per"><a class="equipment_item_credit_btn btn" href="#calculator">Рассчитать кредит</a></td>
    </tr>
    <tr class="fold">
        <td colspan="7">
            <div class="fold-content">
                <p class="save_title_additionally">В дополнение к комплектации 1,8T AT 2WD Comfort:</p>
                <table>
                    <tbody>
                        <tr>
                            <td class="save_title">Функциональное оснащение</td>
                        ...
                        <tr>
                            <td>Система помощи при парковке с отображением расстояния до объекта и звуковым информированием (4-ре датчика в заднем бампере + 2-а датчика в переднем бампере)</td>
                        </tr>
                        <tr>
                            <td>Муфта полного привода с принудительной блокировкой</td>
                        </tr>
                        <tr>
                            <td>Электростеклоподъёмники передних и задних дверей с функцией автоматического открывания и закрывания окна двери водителя и переднего пассажира</td>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Легкосплавные колёсные диски оригинального дизайна 18х7J, двухцветные. Шины 225/60 R18</td>
                        </tr>
                        <tr>
    ...
    <tr class="view">
        <td>1,8T AT 4WD Luxury</td>
        <td class="pcs equipment_item_old_price">2 649 900 руб.</td>
        <td class="cur equipment_item_new_price">2 589 900 руб</td>
        <td>в кредит за 11 990 руб/мес <br> или меньше!</td>
        <td class="per"><a class="equipment_item_credit_btn btn" href="#calculator">Рассчитать кредит</a></td>
    </tr>
    <tr class="fold">
            ...
            <div class="fold-content">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>3-х точечный ремень безопасности водителя и переднего пассажира с преднатяжителем</td>
                        </tr>
                    </tbody>
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            <td>Электроскладываемые наружные зеркала заднего вида окрашенные в цвет кузова
с интегрированными светодиодными указателями поворота, с электрорегулировкой,
подогревом, функцией памяти положения и помощи при движении задним ходом</td>
                        </tr>
                    </tbody>
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            <td>Эргономичное сиденье водителя с боковой поддержкой и электрической
регулировкой в 6-ти направлениях с функцией памяти положения</td>
                        </tr>
                        <tr>
                            <td>Атмосферная подсветка салона (многоцветная)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="popup__container">
        <form class="form title__popup__js  title__popup" id="popup__form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
            ...
            <input type="hidden" name="url" value="<?= $_SERVER['REQUEST_URI'] ?>">
            <input type="hidden" name="SUBJECT" value=" Заявка на Тест-драйв CS75*">
