<li class="accordion">
    ...
    <span class="accordion__title">
        <ul class="equipment_title_two">
            ...
            <div class="compl">
                ...
                <li class="equipment_item_model">2.0 CVT Techno
                </li>
            </div>
            <div class="compl">
                <li class="equipment_item_price_adapt">Цена</li>
                <li class="equipment_item_old_price">1 489 900 руб.</li>
            </div>
            <div class="compl">
                <li class="equipment_item_new_adapt">Финальная цена</li>
                <li class="equipment_item_new_price">1 449 900 руб</li>
            </div>
    ...
    <div class="accordion__content" aria-hidden="true">
        ...
        <ul class="save">
            ...
            <li class="save_item">Скрытая выхлопная труба</li>
        ...
        <ul class="design">
            ...
            <li class="design_item">Камера заднего вида (с системой динамической разметки)
            </li>
            ...
            <li class="design_item">Регулятор тормозных сил в повороте (CBC)
            </li>
        ...
        <ul class="comfort">
            ...
            <li class="comfort_item">Режим Sport/Eco mode
            </li>
            <li class="comfort_item">Гидравлический усилитель рулевого управления
            </li>
            <li class="comfort_item">Бесключевой запуск двигателя кнопкой
            </li>
            <li class="comfort_item">Бесключевой доступ в автомобиль (ключ в кармане)
            </li>
        ...
        <ul class="comfort">
            ...
            <li class="comfort_item">Передние и задние стеклоподъемники с защитой от защемления
            </li>
        ...
        <ul class="comfort">
            <li class="comfort_item">"Умный" ключ-браслет (дополнительное оборудование от 9 900 руб.)
            </li>
            ...
            <li class="comfort_item">2 USB-разъема
            </li>
        </ul>
    </div>
</li>