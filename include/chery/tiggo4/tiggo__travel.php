<li class="accordion">
                        ...
                        <span class="accordion__title">
                            <ul class="equipment_title_two">
                                ...
                                <div class="compl">
                                    ...
                                    <li class="equipment_item_old_price">2 139 900 руб.</li>
                                </div>
                                <div class="compl">
                                    <li class="equipment_item_new_adapt">Финальная цена</li>
                                    <li class="equipment_item_new_price">1 849 900 руб</li>
                                </div>
                        ...
                        <p class="save_title_additionally">В дополнение к комплектации 1,5 CVT Luxury:</p>
                            ...
                            <ul class="save">
                                <li class="save_item">17-дюймовые алюминиевые литые диски</li>
                                <li class="save_item">Электропривод складывания зеркал</li>
                                <li class="save_item">Панорамный люк</li>
                            </ul>
                            <h3 class="design_title">Безопасность</h3>
                            <ul class="design">
                                <li class="design_item">Боковые передние подушки безопасности</li>
                                <li class="design_item">Водительское сиденье с электр.регулировкой в 6 напр. (продольная, по высоте, наклону спинки)</li>
                                ...
                                <li class="design_item">Очешник</li>
                            </ul>
                            <h3 class="comfort_title">Комфорт</h3>
                            <ul class="comfort">
                                <li class="comfort_item">Обогрев задних сидений</li>
                                <li class="comfort_item">Водительское сиденье с электр.регулировкой в 6 напр. (продольная, по высоте, наклону спинки)</li>
                                <li class="comfort_item">Передние и задние стеклоподъемники с защитой от защемления</li>
                            </ul>
                        </div>
                    </li>