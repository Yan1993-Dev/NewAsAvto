...
<main>
    ...
    <div class="container_complictation">
        <table class="fold-table">
            ...
            <tbody>
                <tr class="view">
                    <td>1.5 DCT Prestige</td>
                    <td class="pcs equipment_item_old_price">2 879 900 руб.</td>
                    <td class="cur equipment_item_new_price">2 479 900 руб.</td>
                        ...
                        <div class="fold-content">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Окраска металлик, зеркала и ручки в цвет кузова</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Светодиодные фары основного света и задние фары</td>
                                    </tr>
                                    <tr>
                                        <td>Боковые зеркала с электрической регулировкой и обогревом</td>
                                    </tr>
                                    <tr>
                                        <td>Боковые зеркала с повторителями поворотов</td>
                                    </tr>
                                    <tr>
                                        <td>Боковые зеркала с электроприводом складывания и подсветкой</td>
                                    </tr>
                                    <tr>
                                        <td>Пороги с подсветкой</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Система кругового обзора 360° и передние датчики парковки</td>
                                    </tr>
                                    <tr>
                                        <td>Передние и задние датчики парковки</td>
                                    </tr>
                                    <tr>
                                        <td>Система мониторинга давления и температуры в шинах (TPMS)</td>
                                    </tr>
                                    <tr>
                                        <td>Система безопасности ESP Bosch 9.3 (ABS/HHC/HDC и другое)</td>
                                    </tr>
                                    <tr>
                                        <td>6 подушек безопасности</td>
                                    </tr>
                                    <tr>
                                        <td>Передние ремни с регулировкой по высоте и преднатяжителями</td>
                                    </tr>
                                    <tr>
                                        <td>Детский замок и система Isofix для задних сидений</td>
                                    </tr>
                                    <tr>
                                        <td>Датчик света и функция отсрочки выключения фар (follow me home)</td>
                                    </tr>
                                    <tr>
                                        <td>Датчик дождя (включение работы дворников при дожде)</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Многофункциональный кожаный руль</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Обогрев лобового стекла, форсунок, рулевого колеса</td>
                                    </tr>
                                    <tr>
                                        <td>Обогрев сидений 2-го ряда</td>
                                    </tr>
                                    <tr>
                                        <td>Рулевая колонка с регулировкой в 4-х направлениях</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Складная спинка сидений 2-го (1/3-2/3) и 3-го ряда (1/2-1/2) в ровный пол</td>
                                    </tr>
                                    <tr>
                                        <td>Подголовники всех сидений с регулировкой по высоте</td>
                                    </tr>
                                    <tr>
                                        <td>Климат-контроль, 2 зоны + дефлекторы для 2-го ряда</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Большой сенсорный емкостный дисплей 10.25"</td>
                                    </tr>
                                    <tr>
                                        <td>Цветной экран с бортовым компьютером в панели приборов 7"</td>
                                    </tr>
                                    <tr>
                                        <td>Экран панели управления климатом 8"</td>
                                    </tr>
                                    <tr>
                                        <td>Bluetooth и 3 USB-разъема</td>
                                    </tr>
                                    <tr>
                                        <td>Доступ к навигации, видеофайлам, интернет через смартфон на экране автомобиля</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <form class="form title__popup__js  title__popup" id="popup__form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
            ...
            <input type="hidden" name="url" value="<?= $_SERVER['REQUEST_URI'] ?>">
            <input type="hidden" name="SUBJECT" value=" Заявка на Тест-драйв Tiggo8*">
