<li class="accordion">
                        ...
                        <span class="accordion__title">
                            <ul class="equipment_title_two">
                                ...
                                <div class="compl">
                                    ...
                                    <li class="equipment_item_old_price">3 339 900 руб.</li>
                                </div>
                                <div class="compl">
                        ...
                        <div class="accordion__content" aria-hidden="true">
                            ...
                            <ul class="design">
                                ...
                                <li class="design_item">Камера заднего вида (с системой динамической разметки)</li>
                                ...
                                <li class="design_item">Система помощи при старте в гору (HHC)</li>
                            ...
                            <ul class="comfort">
                                ...
                                <li class="comfort_item">Электрический ручной стояночный тормоз с функцией AutoHold</li>
                                ...
                                <li class="comfort_item">Дистанционное управление открытием двери багажника и открытие кнопкой из салона</li>
                                <li class="comfort_item">Электропривод двери багажника (открытие багажника без помощи рук)</li>
                                <li class="comfort_item">Напоминание об усталости водителя</li>
                                <li class="comfort_item">Индикатор расхода топлива и напоминания о ТО</li>
                            </ul>
                            <h3 class="design_title">Комфорт</h3>
                            <ul class="design">
                                <li class="design_item">Система дистанционного запуска двигателя и прогрева салона</li>
                                <li class="design_item">Обогрев передних сидений</li>
                                <li class="design_item">Обогрев сидений 2-го ряда</li>
                                <li class="design_item">Обогрев рулевого колеса</li>
                                ...
                                <li class="design_item">Карманы в передних сидениях</li>
                                ...
                                <li class="design_item">Система улучшенной фильтрации воздуха в салоне (фильтр N95)</li>
                                ...
                                <li class="design_item">Потолочные светодиодные светильники для 1,2,3 ряда сидений</li>
                            </ul>
                            <h3 class="comfort_title">Технологии и мультимедиа</h3>
                            <ul class="comfort">
                                <li class="comfort_item">Беспроводная зарядка для смартфона</li>
