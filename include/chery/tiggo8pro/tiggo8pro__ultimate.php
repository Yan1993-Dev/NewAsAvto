<li class="accordion">
                        ...
                        <span class="accordion__title">
                            <ul class="equipment_title_two">
                                ...
                                <div class="compl">
                                    ...
                                    <li class="equipment_item_old_price">3 589 900 руб.</li>
                                </div>
                                <div class="compl">
                        ...
                        <p class="save_title_additionally">В дополнение к комплектации Dreamline</p>
                            <ul class="save">
                                ...
                                <li class="save_item">Система распознавания дорожных знаков SLA</li>
                                <li class="save_item">Предупреждение при опасности при открытии дверей DOW</li>
                                <li class="save_item">Предупреждение о заднем перекрестном столкновении RCTA</li>
                                <li class="save_item">Автоматическое переключение ближнего/дальнего света IHC</li>
                            </ul>
                        </div>
                    </li>