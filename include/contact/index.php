...
<div class="container_site">
    <div class="title">
        <h1 class="text__title" id="calculator">Контакты</h1>
    </div>
    <div class="desc__inner">
        <p class="desc">Если Вы хотите связаться с представителями Службы клиентской поддержки, позвоните нам по телефону:</p>
        <a href="tel: +7 (846) 215-07-58" class="desc__phone"><img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/phone.svg" alt="" class="phone__icon">+7 (846) 215-00-07</a>
        <p class="desc">или отправьте e-mail:</p>
        <a href="email:nbalashova@asavtomotors.ru" class="desc__phone"><img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/envelopes.png" alt="" class="phone__icon">nbalashova@asavtomotors.ru</a>
    </div>
</div>
