...
<main>
            ...
            <div class="slider-container">
                <div class="swiper-container__title">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/vxBlue.png" src="#" alt=""></div>
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/vxWhite.png" alt=""></div>
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/vxViolet.png" alt=""></div>
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/vxGrey.png" alt=""></div>
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/vxBlack.png" alt=""></div>
                    </div>
                    <div class="swiper_pagination">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/vxBlue.svg" alt="" class="slider_img_title">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/vxWhite.svg" alt="" class="slider_img_title">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/vxViolet.svg" alt="" class="slider_img_title">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/vxGrey.svg" alt="" class="slider_img_title">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/vxBlack.svg" alt="" class="slider_img_title">
                    </div>
                </div>
            </div>
        </div>
        <div class="form_wrapper">
            <section class="form_traid-in">
                ...
                <form class="form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
                    ...
                    <input type="hidden" name="SUBJECT" value=" Заявка на Trade-in Exeed VX*">
    ...
    <div class="container_complictation">
        <table class="fold-table">
            ...
            <tbody>
                <tr class="view">
                    <td>2.0 TGDI DCT7 4WD LUXURY</td>
                    <td class="pcs equipment_item_old_price">4 879 900 руб.</td>
                    <td class="cur equipment_item_new_price">4 149 900 руб.</td>
                        ...
                        <div class="fold-content">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Боковые зеркала с повторителями поворотов, электроприводом складывания, обогревом</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Отделка интерьера с элементами из дерева</td>
                                    </tr>
                                    <tr>
                                        <td>Хромированные пороги дверей cпереди и сзади</td>
                                    </tr>
                                    <tr>
                                        <td>Панорамная крыша о люком</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Система помощи при спуске с горы (НDС)</td>
                                    </tr>
                                    <tr>
                                        <td>Антипробукcовочная система (TCS)</td>
                                    </tr>
                                    <tr>
                                        <td>Система уменьшения крена (RMI)</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Предупреждение о заднем перекрестном столкновении (RCТW)</td>
                                    </tr>
                                    <tr>
                                        <td>Предупреждение о6 обратном столкновении (RCW)</td>
                                    </tr>
                                    <tr>
                                        <td>Предупреждение о быстром приближении автомобиля (CVW)</td>
                                    </tr>
                                    <tr>
                                        <td>Ассистент при открывании дверей (DOW)</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Напоминание о непристегнутых ремнях спереди и сзади</td>
                                    </tr>
                                    <tr>
                                        <td>Ремни безопасности с преднатяжителями спереди</td>
                                    </tr>
                                    <tr>
                                        <td>Ремни безопасности спереди и регулировкой по высоте</td>
                                    </tr>
                                    <tr>
                                        <td>Система удержания детских кресел lsofix для сидений 2-го ряда</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Режим Eco/Normal/Sport mode</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Обогрев и вентиляция передних сидений</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Кожаная отделка сидений с перфорацией (Luх)</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Складная спинка сидения 3-го ряда (в ровный пол)</td>
                                    </tr>
                                    <tr>
                                        <td>Подголовники 7 сидений с регулировкой по высоте</td>
                                    </tr>
                                    <tr>
                                        <td>Климат-контроль, 3 зоны, с интеллектуальной системой очистки воздуха и фильтрации (AQS)</td>
                                    </tr>
                                    <tr>
                                        <td>Управление климатом на 2-м ряду</td>
                                    </tr>
                                    <tr>
                                        <td>Дефлекторы для 2-го и 3-го ряда сидений</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Передний центральный подлокотник с ёмкостью дпя хранения и подстаканниками</td>
                                    </tr>
                                    <tr>
                                        <td>Центральный подлокотник 2-го ряда с подстаканниками</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Потолочные светодиодные светильники дпя 1-го, 2-го, 3-го ряда сидений</td>
                                    </tr>
                                    <tr>
                                        <td>Очечник</td>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Система «Сво6одные руки» (Напds fгее) с Вluеtооth-связью с мобильным телефоном</td>
                                    </tr>
                                    <tr>
                                        <td>Розетка 12V cпереди и в багажнике</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <tr class="view">
                    <td>2.0 TGDI DCT7 4WD PRESIDENT</td>
                    <td class="pcs equipment_item_old_price">5 249 900 руб.</td>
                    <td class="cur equipment_item_new_price">4 519 900 руб</td>
                    <td>в кредит за 11 990 руб/мес <br> или меньше!</td>
                    <td class="per"><a class="equipment_item_credit_btn btn" href="#calculator">Рассчитать кредит</a></td>
                </tr>
                <tr class="fold">
                    <td colspan="7">
                        <div class="fold-content">
                            <p class="save_title_additionally">В дополнение к комплектации 2.0 TGDI DCT7 4WD LUXURY:</p>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="save_title">Дизайн</td>
                                    ...
                                    <tr>
                                        <td>20-дюймовые алюминиевые литые диски</td>
                                    </tr>
                                    <tr>
                                        <td>Подсветка порогов дверей cпереди и сзади</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Система предотвращения столкновений спереди (FCW+AEB)</td>
                                    </tr>
                                    <tr>
                                        <td>Система удержания в полосе (LКА)</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Кожаная отделка сидений с перфорацией (Prestige)</td>
                                    </tr>
                                    <tr>
                                        <td>Водительское сиденье с электрической регулировкой в 8 направлениях, с памятью настроек</td>
                                    </tr>
                                    <tr>
                                        <td>Водительское сиденье с электрической регулировкой поясничного упора в 4 направлениях</td>
                                    </tr>
                                    <tr>
    ...
    <div class="popup__container">
        <form class="form title__popup__js  title__popup" id="popup__form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
            ...
            <input type="hidden" name="url" value="<?= $_SERVER['REQUEST_URI'] ?>">
            <input type="hidden" name="SUBJECT" value=" Заявка на Тест-драйв VX*">
