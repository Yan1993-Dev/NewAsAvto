<li class="accordion">
    ...
    <span class="accordion__title">
        <ul class="equipment_title_two">
            ...
            <div class="compl">
                ...
                <li class="equipment_item_model">2.0 TGDI DCT7 4WD LUXURY</li>
            </div>
            <div class="compl">
                <li class="equipment_item_price_adapt">Цена</li>
                <li class="equipment_item_old_price">4 879 900 руб.</li>
            </div>
            <div class="compl">
    ...
    <div class="accordion__content" aria-hidden="true">
        ...
        <ul class="save">
            ...
            <li class="save_item">Окраска металлик (на выбор), зеркала и ручки в цвет кузова</li>
            <li class="save_item">Рейлинги на крыше</li>
            <li class="save_item">Двойная выхлопная труба</li>
            <li class="save_item">Задний спортивный спойлер</li>
            <li class="save_item">Передние противотуманные фары</li>
            <li class="save_item">Задние светодиодные фонари</li>
            <li class="save_item">Светодиодные фары основного света с регулировкой светового потока по высоте</li>
            <li class="save_item">Передние дневные светодиодные ходовые огни</li>
            <li class="save_item">Светодиодные задние фонари</li>
            <li class="save_item">Боковые зеркала с повторителями поворотов, электроприводом складывания, обогревом</li>
            <li class="save_item">Наружная подсветка под зеркалами</li>
            <li class="save_item">Динамические сигналы поворота</li>
            <li class="save_item">Отделка интерьера с элементами из дерева</li>
            <li class="save_item">Хромированные пороги дверей cпереди и сзади</li>
            <li class="save_item">Панорамная крыша о люком</li>
        </ul>
        ...
        <ul class="design">
            ...
            <li class="design_item">Система стабилизации курсовой устойчивости (ESP Bosch 9.3)</li>
            <li class="design_item">Антиблокировочная тормозная система (ABS+EBD+CBC)</li>
            <li class="design_item">Система помощи при старте в гору (HSA)</li>
            <li class="design_item">Система помощи при спуске с горы (НDС)</li>
            ...
            <li class="design_item">Круиз-контроль</li>
        ...
        <ul class="comfort">
            ...
            <li class="comfort_item">Система Старт/Стоп</li>
        </ul>
        ...
        <ul class="comfort">
            ...
            <li class="comfort_item">Обогрев форсунок</li>
            <li class="comfort_item">Обогрев рулевого колеса</li>
            <li class="comfort_item">Обогрев заднего стекла</li>
            <li class="comfort_item">Кожаная отделка сидений с перфорацией (Luх)</li>
            ...
            <li class="comfort_item">Управление климатом на 2-м ряду</li>
            ...
            <li class="comfort_item">Потолочные светодиодные светильники дпя 1-го, 2-го, 3-го ряда сидений</li>
            <li class="comfort_item">Очечник</li>
            <li class="comfort_item">Датчик внешней температуры</li>
            <li class="comfort_item">Легкая тонировка стекол</li>
        </ul>
        <h3 class="comfort_title">ТЕХНОЛОГИИ И МУЛЬТИМЕДИА</h3>
        <ul class="comfort">
            <li class="comfort_item">Беспроводная зарядка</li>
            <li class="comfort_item">Радио</li>
            <li class="comfort_item">Автоматическая регулировка громкости в зависимости от скорости движения</li>
