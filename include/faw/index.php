                                ...
                                <div class="field__wrapper">
                                    ...
                                    <div class="field">
                                        ...
                                        <select name="DC" class="input__traid-in">
                                            <option value="s3" class="input__traid-in" >FAW</option>
                                           </select>
                                    </div>
                                    <div class="field">
                                        <label for="input_traid" class="label__traid-in">Время записи</label>
                                        <select name="DC" class="input__traid-in">
                                            <option value="s1" class="input__traid-in">BESTURN X40</option>
                                            <option value="s2" class="input__traid-in">BESTURN X80</option>
                                            <option value="s3" class="input__traid-in">Bestune T77</option>
                                           </select>
                                    </div>
                                    <div class="field">
