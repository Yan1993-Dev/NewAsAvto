<li class="accordion">
    ...
    <span class="accordion__title">
        <ul class="equipment_title_two">
            ...
            <div class="compl">
                ...
                <li class="equipment_item_old_price">3 013 990 руб.</li>
            </div>
            <div class="compl">
                <li class="equipment_item_new_adapt">Финальная цена</li>
                <li class="equipment_item_new_price">2 573 990 руб</li>
            </div>
    ...
    <div class="accordion__content" aria-hidden="true">
        <p class="save_title_additionally">В дополнение к комплектации 1.5T 2WD 6AT LUXURY:</p>
        <h3 class="save_title">ИНТЕЛЕКТАЛЬНЫЕ СИСТЕМЫ</h3>
        <ul class="save">
            <li class="save_item">Система запуска/остановки двигателя Start-Stop
            </li>
