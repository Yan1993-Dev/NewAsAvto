    ...
    <div class="container_site">
        ...
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/atlasPro__exterier.php"
            )
        ); ?>
    </div>
    <div class="container_site">
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/atlasPro__interier.php"
            )
        ); ?>
    </div>
    </div>
    ...
    <div class="container_site">
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/atlasPro__option.php"
            )
        ); ?>
    </div>
    <div class="container_site">
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/atlasPro__technologies.php"
            )
        ); ?>
    </div>
    <div class="container_site">
            ...
            <div class="ex ex-3">
                ...
                <? $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/include/atlasPro__comfort.php"
                        )
                    ); ?>
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        ...
                        array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/include/atlasPro__luxury.php"
                        )
                    ); ?>
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        ...
                        array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/include/atlasPro_luxury4WD.php"
                        )
                    ); ?>
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        ...
                        array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/include/atlasPro__flagship.php"
                        )
                    ); ?>
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        ...
                        array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/include/atlasPro__flagshipPlus.php"
                        )
                    ); ?>
                </ul>
            </div>
