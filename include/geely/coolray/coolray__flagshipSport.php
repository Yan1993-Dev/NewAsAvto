<li class="accordion">
    ...
    <span class="accordion__title">
        <ul class="equipment_title_two">
            ...
            <div class="compl">
                ...
                <li class="equipment_item_model">1.5 DCT FLAGSHIP SPORT (AT)</li>
            </div>
            <div class="compl">
    ...
    <p class="save_title_additionally">В дополнение к комплектации 1.5 DCT FLAGSHIP (AT):</p>
        ...
        <ul class="save">
            ...
            <li class="save_item">Корпуса зеркал заднего вида с отделкой под карбон
            </li>
            <li class="save_item">Спортивный спойлер с красной эмблемой «S»
            </li>
        </ul>
    </div>
</li>