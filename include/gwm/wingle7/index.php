...
<main>
        ...
        <section class="title">
            <? $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/include/wingle__title.php"
                )
            ); ?>
        </section>
            ...
            <div class="slider-container">
                <div class="swiper-container__title">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide card"><img src="<?= SITE_TEMPLATE_PATH ?>/static/images/gwm.png" src="#" alt=""></div>
                    </div>
                    <div class="swiper_pagination">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/static/icons/gwm.svg" alt="" class="slider_img_title">
                    </div>
                </div>
            </div>
        </div>
        <div class="form_wrapper">
            <section class="form_traid-in">
                ...
                <form class="form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
                    ...
                    <input type="hidden" name="SUBJECT" value=" Заявка на Trade-in Wingle 7*">
    ...
    <div class="container_site">
        ...
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/wingle__exterier.php"
            )
        ); ?>
    </div>
    <div class="container_site">
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/wingle__interier.php"
            )
        ); ?>
    </div>
    </div>
    ...
    <div class="container_site">
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/wingle__option.php"
            )
        ); ?>
    </div>
    <div class="container_site">
        <? $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/wingle__technologies.php"
            )
        ); ?>
    </div>
    <div class="container_site">
    ...
    <div class="container_complictation">
        <table class="fold-table">
            ...
            <tbody>
                <tr class="view">
                    <td>2.0TDI (143 л/с) 6MT 4WD Comfort</td>
                    <td class="cur equipment_item_new_price">2 999 000 руб</td>
                    ...
                    <td colspan="7">
                        <div class="fold-content">
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="save_title">Ходовая часть, рулевое управление</td>
                                    </tr>
                                    <tr>
                                        <td>Полный привод с электронным управлением (раздаточная коробка с режимом 4L)</td>
                                    </tr>
                                    <tr>
                                        <td>Гидравлический усилитель руля</td>
                                    </tr>
                                    <tr>
                                        <td>Регулировка руля по высоте</td>
                                    </tr>
                                    <tr>
                                        <td>Блокировка межосевого дифференциала</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                        <td class="save_title">Кузов и интерьер</td>
                                    </tr>
                                    <tr>
                                        <td>16-дюймовые алюминиевые колесные диски</td>
                                    </tr>
                                    <tr>
                                        <td>Полноразмерное запасное колесо, стальной диск</td>
                                    </tr>
                                    <tr>
                                        <td>Шины 235/70 R16</td>
                                    </tr>
                                    <tr>
                                        <td>Передний бампер, окрашенный в цвет кузова</td>
                                    </tr>
                                    <tr>
                                        <td>Задний бампер, окрашенный в цвет кузова</td>
                                    </tr>
                                    <tr>
                                        <td>Хромированная решетка радиатора (усиленный хром - гальванизация)</td>
                                    </tr>
                                    <tr>
                                        <td>Усиленное антикоррозийнное покрытие днища (оцинковка)</td>
                                    </tr>
                                    <tr>
                                        <td>Защитное внутреннее покрытие кузова - пола, бортов, колесных арок; напыление против царапин</td>
                                    </tr>
                                    <tr>
                                        <td>Такелажные кольца фикскации груза в кузове (4шт)</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                        <td class="save_title">Внутренняя конфигурация</td>
                                    </tr>
                                    <tr>
                                        <td>Кожаный руль</td>
                                    </tr>
                                    <tr>
                                        <td>Управление аудио + Bluetooth + круиз-контролем на рулевом колесе</td>
                                    </tr>
                                    <tr>
                                        <td>Матричный экран бортового компьютера</td>
                                    </tr>
                                    <tr>
                                        <td>Регулировка яркости подсветки приборов и органов управления приборной панели</td>
                                    </tr>
                                    <tr>
                                        <td>Розетка 12В, 1шт</td>
                                    </tr>
                                    <tr>
                                        <td>Круиз-контроль</td>
                                    </tr>
                                    <tr>
                                        <td>Потолочная ручка салона со стороны пассажира</td>
                                    </tr>
                                    <tr>
                                        <td>Потолочная ручка салона пассажиров заднего ряда (2 шт.)</td>
                                    </tr>
                                    <tr>
                                        <td>Два полноразмерных подстаканника на центральном тоннеле</td>
                                    </tr>
                                    <tr>
                                        <td>Центральный подлокотник с вещевым отделением, регулируемой по вылету подушкой, обитый искусственной кожей</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                        <td class="save_title">Конфигурация сидений</td>
                                    </tr>
                                    <tr>
                                        <td>Сиденье из износостойкой ткани</td>
                                    </tr>
                                    <tr>
                                        <td>Подогрев передних сидений</td>
                                    </tr>
                                    <tr>
                                        <td>Ручная регулировка сиденья водителя в 6-ти направлениях</td>
                                    </tr>
                                    <tr>
                                        <td>Ручная регулировка сиденья пассажира в 4-ех направлениях</td>
                                    </tr>
                                    <tr>
                                        <td>Фиксированные задние сиденья со складной спинкой</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                        <td class="save_title">Первичная и пассивная безопасность</td>
                                    </tr>
                                    <tr>
                                        <td>ABS + EBD</td>
                                    </tr>
                                    <tr>
                                        <td>Усилитель тормозов BA</td>
                                    </tr>
                                    <tr>
                                        <td>ESP</td>
                                    </tr>
                                    <tr>
                                        <td>Передние и задние дисковые тормоза</td>
                                    </tr>
                                    <tr>
                                        <td>Фронтальные подушки безопасности водителя и пассажира</td>
                                    </tr>
                                    <tr>
                                        <td>Система экстренного вызова ЭРА-ГЛОНАСС</td>
                                    </tr>
                                    <tr>
                                        <td>Передние ремни безопасности с регулировкой по высоте</td>
                                    </tr>
                                    <tr>
                                        <td>Сигнализаиция непристегнутого ремня безопасности водителя</td>
                                    </tr>
                                    <tr>
                                        <td>Средний подголовник заднего сиденья</td>
                                    </tr>
                                    <tr>
                                        <td>Детский замок задних дверей</td>
                                    </tr>
                                    <tr>
                                        <td>Функция запирания центрального замка при движении (15 км/ч)</td>
                                    </tr>
                                    <tr>
                                        <td>Функция автоматической разблокировки центрального замка при столкновении</td>
                                    </tr>
                                    <tr>
                                        <td>Функция блокировки подачи топлива и масла при аварии</td>
                                    </tr>
                                    <tr>
                                        <td>Усиленный каркас двери</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="save_title">Противоугонное устройство</td>
                                    </tr>
                                    <tr>
                                        <td>Иммобилайзер</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Функция автоблокировки центрального замка при случайном нажатии (30 сек, если дверь не открыта)</td>
                                    </tr>
                                    <tr>
                                        <td>Сигнализация открытых дверей</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="save_title">Остекление</td>
                                    </tr>
                                    <tr>
                                        <td>Заднее стекло с электрообогревом</td>
                                    </tr>
                                    <tr>
                                        <td>Обогрев зон покоя стеклоочистителей</td>
                                    </tr>
                                    <tr>
                                        <td>Электро стеклоподъёмник водительской двери с автодоводчиком</td>
                                    </tr>
                                    <tr>
                                        <td>Зеркала заднего вида с электроприводом и обогревом, ручным складыванием; колпаки зеркал в цвет кузова</td>
                                    </tr>
                                    <tr>
                                        <td>Ручное антибликовое зеркало заднего вида</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                        <td class="save_title">Освещение</td>
                                    </tr>
                                    <tr>
                                        <td>Задний противотуманный фонарь</td>
                                    </tr>
                                    <tr>
                                        <td>Галогенные линзованные фары ближнего и дальнего света</td>
                                    </tr>
                                    <tr>
                                        <td>Светодиодные дневные ходовые огни, интегрированные в фару</td>
                                    </tr>
                                    <tr>
                                        <td>Высокий стоп-сигнал</td>
                                    </tr>
                                    <tr>
                                        <td>Электрокорректор фар</td>
                                    </tr>
                                    <tr>
                                        <td>Свет для чтения - передний потолочный светильник</td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                        <td class="save_title">Вентиляция и кондиционирование</td>
                                    </tr>
                                    <tr>
    ...
    <form class="form title__popup__js  title__popup" id="popup__form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
            ...
            <input type="hidden" name="url" value="<?= $_SERVER['REQUEST_URI'] ?>">
            <input type="hidden" name="SUBJECT" value=" Заявка на Тест-драйв Wingle 7*">
