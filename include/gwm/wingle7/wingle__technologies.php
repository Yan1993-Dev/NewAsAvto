    ...
    <div class="swiper-container_one">
        <div class="swiper-wrapper_one">
            ...
            <div class="swiper__inner__wrp">
                ...
                <p class="text_slide">Пикап GWM Wingle 7 подходит под любые задачи. Задний ряд сидений рассчитан на 3 человек, сиденья можно сложить и получить место для дополнительного груза.</p>
            </div>
        </div>
