<li class="accordion">
    ...
    <span class="accordion__title">
        <ul class="equipment_title_two">
            ...
            <div class="compl">
                ...
                <li class="equipment_item_model">2.0T DCT 4WD Premium</li>
            </div>
            <div class="compl">
            ...
            <div class="compl">
                ...
                <li class="equipment_item_new_price">2 829 000 руб</li>
            </div>
    ...
    <h3 class="comfort_title">Технические характеристики</h3>
        <ul class="comfort">
            <li class="comfort_item">Двигатель 2.0, турбированный, 190 л/с
            </li>
        </ul>
    </div>
</li>