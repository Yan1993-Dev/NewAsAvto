<li class="accordion">
    ...
    <span class="accordion__title">
        <ul class="equipment_title_two">
            ...
            <div class="compl">
                ...
                <li class="equipment_item_old_price">3 159 000 руб.</li>
            </div>
            <div class="compl">
                <li class="equipment_item_new_adapt">Финальная цена</li>
                <li class="equipment_item_new_price">3 009 000 руб</li>
            </div>
    ...
    <p class="save_title_additionally">В дополнение к комплектации ELITE:</p>
        ...
        <ul class="save">
            <li class="save_item">Панорамная крыша с люком
            </li>
        </ul>
        <h3 class="design_title">ИНТЕРЬЕР</h3>
        <ul class="design">
            <li class="design_item">Сиденья с отделкой искусственной кожей</li>
        </ul>
...
(стандартная опция для комплектации Premium, кроме двигателя 1.5T в комбинации с передним приводом)
            </li>
        </ul>
    </div>
</li>