...
$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH . "/css/catalogPageHaval.css");
?>
<nav class="nav">
    <ul class="navigation">
        ...
        <div class="title__poster">
            <div class="colors__poster">
                <div class="color__poster">
                    <p class="title__poster__text">Кроссоверы и внедорожники Haval</p>
                    <p class="title__desc__poster">Оцените технологичные кроссоверы и внедорожники HAVAL, адаптированные
                        к российским условиям.</p>
                </div>
            </div>
        </div>
        <ul class="offer">
            <li class="offer__item">Яркий и свежий дизайн</li>
            <li class="offer__item">Полный или передний привод</li>
            <li class="offer__item">Продвинутые опции</li>
            <li class="offer__item">Адаптация к российским условиям</li>
        </ul>
    </div>
</div>
            ...
            <li class="catalog__item__li">
                <a href="/haval/f7/index.php" class="tabs__link__fl">
                    ...
                    <div class="tabs__item__desc">
                        ...
                        <p class="model_catalog__price">от 2 599 000 руб.</p>
                    </div>
                </a>
            </li>
            <li class="catalog__item__li">
                <a href="/haval/f7x/index.php" class="tabs__link__fl">
                    ...
                    <div class="tabs__item__desc">
                        ...
                        <p class="model_catalog__price">от 2 669 000 руб.</p>
                    </div>
                </a>
            </li>
            <li class="catalog__item__li">
            ...
            <section class="form_traid-in">
                ...
                <form class="form" enctype="multipart/form-data" action="/ajax/feedback.php" method="POST">
                    ...
                    <div class="field__wrapper">
                        ...
                        <div class="field">
                            ...
                            <select name="choose_marka" class="input__traid-in">
                                <option value="HAVAL" class="input__traid-in">HAVAL</option>
                            </select>
                        </div>
                        <div class="field">
                            <label for="input_traid" class="label__traid-in">Выберите модель</label>
                            <select name="choose_model" class="input__traid-in">
                                <option value="F7" class="input__traid-in">F7</option>
                                <option value="F7X" class="input__traid-in">F7X</option>
                                <option value="Jolion" class="input__traid-in">Jolion</option>
                            </select>
                        </div>
                        <div class="field">
                    ...
                    <div class="checkbox_popup">
                        ...
                        <input type="hidden" name="SUBJECT" value=" Заявка на Тест-драйв Haval*">
...
<div class="container_site">
    <p class="seo__title">Адаптация к российским условиям - главное преимущество автомобилей Haval, судите сами:</p>
    <ul>
        <li class="seo__list-item">Любая модель доступна как в исполнении 2WD, так и 4WD.</li>
        <li class="seo__list-item">Комплект «зимних опций»: обогревы сидений, руля, стёкол и форсунок стеклоомывателя.</li>
        <li class="seo__list-item">Дорожный просвет от 180 мм.</li>
    </ul>
    <p class="seo__list__title">Актуальный модельный ряд Haval в России состоит из 3 кроссоверов:</p>
    <ul>
        <li class="seo__list-item">F7</li>
        <li class="seo__list-item">F7x</li>
        <li class="seo__list-item">Jolion</li>
    </ul>
    <p class="seo__list__title">Производство автомобилей осуществляется на собственном заводе Haval в Тульской области. </p>
    <ul>
        <li class="seo__list__title">Высокий уровень качества автомобилей Haval достигается многоступенчатым контролем качества каждого производимого автомобиля. Производитель уверен в своём продукте и предлагает привлекательные условия гарантии на а/м: 36 месяцев или 150 тыс. км пробега. Гарантия на КПП F-серии 200 тыс. км. пробега, гарантия от сквозной коррозии на Jolion 6 лет без ограничения по пробегу.</li>
        <li class="seo__list__title">Выгодные условия кредитования по программе Haval Finance позволяют приобрести автомобиль в кредит с минимальной переплатой и удобным графиком платежей.</li>
    </ul>
</div>
