                                ...
                                <div class="field__wrapper">
                                    ...
                                    <div class="field">
                                        ...
                                        <select name="DC" class="input__traid-in">
                                            <option value="s3" class="input__traid-in">HAVAL</option>
                                           </select>
                                    </div>
                                    <div class="field">
                                        <label for="input_traid" class="label__traid-in">Выберите модель</label>
                                        <select name="DC" class="input__traid-in">
                                            <option value="s1" class="input__traid-in">F7</option>
                                            <option value="s2" class="input__traid-in">F7X</option>
                                            <option value="s5" class="input__traid-in">Jolion</option>
                                           </select>
                                    </div>
                                    <div class="field">
