<li class="accordion">
    ...
    <span class="accordion__title">
        <ul class="equipment_title_two">
            ...
            <div class="compl">
                ...
                <li class="equipment_item_old_price">2 379 000 руб.</li>
            </div>
            <div class="compl">
                <li class="equipment_item_new_adapt">Финальная цена</li>
                <li class="equipment_item_new_price">2 019 000 руб</li>
            </div>
    ...
    <p class="save_title_additionally">В дополнение к комплектации 1.5T 6MT 2WD Elite:</p>
        ...
        <ul class="save">
            <li class="save_item">Система выбора режима движения (standard, eco, sport, snow)
            </li>
        </ul>
        <h3 class="save_title">ОБОРУДОВАНИЕ</h3>
        <ul class="save">
