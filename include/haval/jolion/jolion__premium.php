<li class="accordion">
    ...
    <span class="accordion__title">
        <ul class="equipment_title_two">
            ...
            <div class="compl">
                ...
                <li class="equipment_item_model">PREMIUM 2WD АКПП</li>
            </div>
            <div class="compl">
                <li class="equipment_item_price_adapt">Цена</li>
                <li class="equipment_item_old_price">2 549 000 руб.</li>
            </div>
            <div class="compl">
                <li class="equipment_item_new_adapt">Финальная цена</li>
                <li class="equipment_item_new_price">2 339 000 руб</li>
            </div>
    ...
    <div class="accordion__content" aria-hidden="true">
        ...
        <ul class="save">
            <li class="save_item">Тонированные стекла (задние)
            </li>
        </ul>
    </div>
</li>