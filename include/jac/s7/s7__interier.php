        ...
        <div class="slider-container_one">
            <div class="swiper-container_one">
                <div class="swiper-wrapper_one">
                    <div class="swiper-slide_one card_one"><img data-src="<?= SITE_TEMPLATE_PATH ?>/static/images/interior_1.jpg" src="#" alt="" class="img_slider_one">
                    ...
                    <div class="swiper-slide_one card_one"><img data-src="<?= SITE_TEMPLATE_PATH ?>/static/images/interior_2.jpg" src="#" alt="" class="img_slider_one">
                    ...
                    <div class="swiper-slide_one card_one"><img data-src="<?= SITE_TEMPLATE_PATH ?>/static/images/interior_3.jpg" src="#" alt="" class="img_slider_one">
                        <p class="text_slide">Кожаная обивка салона с декоративной прострочкой - изысканность в деталях без ущерба комфорту.</p>
                    </div>
                    <div class="swiper-slide_one card_one"><img data-src="<?= SITE_TEMPLATE_PATH ?>/static/images/interior_4.jpg" src="#" alt="" class="img_slider_one">
                    ...
                    <div class="swiper-slide_one card_one"><img data-src="<?= SITE_TEMPLATE_PATH ?>/static/images/interior_5.jpg" src="#" alt="" class="img_slider_one">
