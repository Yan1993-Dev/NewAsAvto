...
<main>
    <div class="container_site">
        <h1 class="title__news">Кубок мэра по конному спорту в клубе HERMES</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/IMG_3470.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">04.06.2022</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">4 июня  наш ДЦ АсАвто представлял автомобили бренда EXEED на городских соревнованиях по конному спорту в загородном комплексе HERMES.</p>
                <p class="news__desc-text">На боевом поле клуба встретились  спортивные пары Саратовского и соседних регионов. Всадники в течение 3-х дней турнира преодолевали различные маршруты с высотой препятствий от 50 до 130 см.</p>
                <p class="news__desc-text">Событие было ярким и интересным. Спортсмены и любители конного спорта смогли хорошо провести время и получить незабываемые эмоции.</p>
                <p class="news__desc-text">Помимо этого, гости мероприятия имели возможность познакомиться поближе с EXEED VX и TXL, и оценить все возможности и преимущества на тест- драйве. Автомобили EXEED отличаются высоким качеством, технологичностью и премиальным уровнем комфорта.</p>
            </div>
        </div>
    </div>
