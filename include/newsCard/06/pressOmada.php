...
<main>
    <div class="container_site">
        <h1 class="title__news">Автопарад на День города Тольятти</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/IMG_6216.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">05.06.2022</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">День города Тольятти прошёл , как всегда ярко и интересно!</p>
                <p class="news__desc-text">Компания «АвтоСреда» в 17-й раз провела  АВТОПАРАД в День города автомобильной столицы. Колонна редких, старинных, красивых, самодельных и других необычных автомобилей проходит по трём районам Тольятти.</p>
                <p class="news__desc-text">В параде приняли участие «Жигули» во главе с «копейкой» ГАИ, и легенды советского производства: «Волги», «Победы», «Москвичи», «Запорожцы», и раритеты мирового автопрома – например, «Трабант» производства ГДР 1972 года, всех не перечислить.</p>
                <p class="news__desc-text">Наш ДЦ АсАвто  не остался в стороне и представил современный и технологичный CHERY TIGGO 7 PRO/  EXEED TXL.</p>
                <p class="news__desc-text">Участники и гости автошоу смогли сравнить автомобили прошлого и настоящего.</p>
                <p class="news__desc-text">Согласитесь , что это очень интересно ?</p>
                <p class="news__desc-text">Производство автомобилей идёт в ногу со временем , поэтому мы уверены , что CHERY/EXEED со стопроцентной уверенностью можно  назвать одним из лучших автомобильных брендов  современности.</p>
                <p class="news__desc-text">Убедитесь сами , запишитесь на тест - драйв в наш ДЦ и оцените все возможности и преимущества понравившегося автомобиля.</p>
            </div>
        </div>
    </div>
...
<? require($_SERVER["DOCUMENT_ROOT"] . "/bitrix/footer.php"); ?></h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/OMODA_C5_1.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">20.06.2022</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">В ближайшие месяцы российский автомобильный рынок ожидают новые перемены. Компания АО «ЧЕРИ АВТОМОБИЛИ РУС» объявляет о расширении своего присутствия в России и намерена представить третий бренд – OMODA.</p>
                <p class="news__desc-text">Для марки будет создана индивидуальная дилерская сеть на конкурсной основе, включающая на первом этапе 100 партнёров. В планах компании заключить дилерские соглашения до конца лета этого года, в связи с чем в ближайшие дни потенциальным кандидатам компания направит приглашение.</p>
                <p class="news__desc-text">Автомобили марки OMODA на российском рынке займут позиции в сегменте high middle. Они станут достойной альтернативой японским и немецким маркам, приостановившим свою деятельность в России. Линейка бренда OMODA будет состоять из трёх моделей: два кроссовера и седан, которые поэтапно будут представлены до лета 2023 года. К 2025 году модельный ряд будет дополнительно расширен и обновлён.</p>
                <p class="news__desc-text">Кроссовер OMODA C5 поступит в продажу первым. Представлять стильную новинку на российском рынке доверено олимпийской чемпионке по фигурному катанию Анне Щербаковой.</p>
                <p class="news__desc-text">Заслуга футуристичного облика OMODA С5 принадлежит международной команде дизайнеров под руководством Стива Юма. Автомобиль разрабатывался в рамках концепции «Art in Motion», в основе которой авангардное искусство, как эксперимент — с концепцией, цветом, формой.</p>
            </div>
        </div>
    </div>
    <div class="background__fos">
