...
<main>
    <div class="container_site">
        <h1 class="title__news">Android Auto доступен в системах мультимедиа 7PRO и 8PRO</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/gjc3ibcrcj1p0e5uo3ju4ntdmxmbo2sc.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Дистрибьютор автомобильной марки CHERY в России предоставляет возможность владельцам кроссоверов TIGGO 7 PRO и TIGGO 8 PRO обновить систему мультимедиа для использования Android Auto.</p>
                <p class="news__desc-text">Услуга по обновлению системы мультимедиа оказывается на безвозмездной основе в сервисных центрах официальных дилеров марки CHERY в России.</p>
                <p class="news__desc-text">Использование программы Android Auto позволяет расширить функционал головного устройства автомобиля. После установки приложения, пользователь сможет: получать данные о пробках, прокладывать маршрут, применяя google-карты; с помощью голосовых команд можно управлять системой и совершать звонки; слушать аудиокниги, музыку и другое; пользователь сможет вести общение в соцсетях и мессенджерах, отправляя сообщение голосовой командой и другое.</p>
                <p class="news__desc-text">Обновление системы мультимедиа доступно для комплектаций Luxury, Elite, Prestige модели CHERY TIGGO 7 PRO и для модели TIGGO 8 PRO в исполнении Speedline, Dreamline. В кроссовере TIGGO 8 PRO версии Ultimate последняя версия системы мультимедиа уже установлена.</p>
            </div>
        </div>
    </div>
