...
<main>
    <div class="container_site">
        <h1 class="title__news">Электрификация модельного ряда CHERY в России. Уже скоро
        </h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/0300f65f9a659a0fcbf289d906af6d88.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Компания CHERY рассматривает возможность в ближайшие два года расширить модельный ряд в России автомобилями с электродвигателями. В настоящее время специалисты компании готовят необходимый пакет технической документации для прохождения обязательной процедуры сертификации, проводят маркетинговые опросы и готовятся к испытаниям электрокара в условиях российских дорог и климата.</p>
                <p class="news__desc-text">Научно-исследовательские работы и разработки в области новых энергетических технологий компания CHERY начала ещё в 1999 году, и входит в число первых компаний Китая, сфокусированных на данном направлении.</p>
                <p class="news__desc-text">Модельный ряд электромобилей CHERY в Китае в настоящее время включает в себя семь моделей: Little Ant (EQ1), Ant, Tiggo E (Tiggo 4), Arrizo E (Arrizo 5), Tiggo3xe (Tiggo 2), eQ и eQ2. Среди них одним из самым популярных считается компакт-кар EQ1. Автомобиль официально был представлен в 2017 году и на днях продажи данной модели пересекли отметку в 200 000 штук.</p>
                <p class="news__desc-text">Модель EQ1 является лидером среди мини-BEV в Китае и даже в мире. С момента своего запуска EQ1 прошёл четыре периода эволюции и получил множество профессиональных наград в Китае: первый BEV собственной разработки, первый легкий BEV с алюминиевым кузовом, первый двухдверный четырехместный BEV с запасом хода более 300 км, а также первый BEV с функцией автоматической парковки и самым высоким уровнем готовности для путешествий.</p>
                <p class="news__desc-text">Однако эволюция EQ1 всё ещё продолжается. На автомобильном салоне в Шанхае в апреле этого года CHERY представила два концептуальных автомобиля, отражающие тенденции будущего — EQZ и EQX.</p>
                <p class="news__desc-text">EQZ — это первая серийная модель CHERY, оснащенная интеллектуальной вспомогательной системой уровня L2.99, которая включает в себя 16 ассистентов водителя: адаптивный круиз-контроль, центрирование полосы движения, автоматическое экстренное торможение, автоматическую парковку, круговой обзор 360°, предупреждение об опасности столкновения с функцией автоматического торможения и многое другое.</p>
                <p class="news__desc-text">Электрический автомобиль EQX оснащен функцией автоматического вождения уровня L4 — верхний уровень автоматизации вождения, не требующий человеческого вмешательства в управление транспортным средством в условиях соответствующей инфраструктуры.</p>
                <p class="news__desc-text">В настоящее время разработка транспортных средств на новой энергии является национальной стратегией США, Германии, Китая и других стран. В частности, в Китае быстро развивается промышленность по производству автомобилей на альтернативных источниках энергии. Китайские автомобильные бренды нацелены реализовать стратегию развития и наращивания продаж за счёт высокотехнологичных продуктов, стремясь осуществить скачкообразное развитие от «последователя» до «лидера». Компания CHERY обладает всеми необходимыми ресурсами для осуществления данной стратегии в числе первых.</p>
            </div>
        </div>
    </div>
