...
<main>
    <div class="container_site">
        <h1 class="title__news">Новый EXEED VX. Старт продаж 2 декабря 2021
</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/zu5ixhv6r8vnto8g2zoqq5go78akwjrx.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Новая флагманская модель от EXEED - внедорожник VX официально выходит на Российский рынок.</p>
                <p class="news__desc-text">Модель будет оснащена мощным двухлитровым бензиновым двигателем мощностью 249 л/с и турбонаддувом, в паре с которым выступит семиступенчатая роботизированная КПП Magna Getrag.</p>
                <p class="news__desc-text">VX достаточно большой автомобиль, длина без малого 5 метров!</p>
                <p class="news__desc-text">Просторный салон на 7 мест выполнен в современном стиле с использованием натуральных материалов: кожа, дерево, алюминий.</p>
                <p class="news__desc-text">Автомобиль оборудован комплексом систем безопасности ADAS, делающим вождение максимально комфортным и безопасным.</p>
                <p class="news__desc-text">Среди опций числятся: атмосферная подсветка салона с возможностью выбора цвета и яркости, панорамная сдвижная крыша, проекционный дисплей на лобовом стекле, премиальная акустика Sony, автопарковщик, два больших монитора диагональю более 12 дюймов, трёхзонный климат-контроль.</p>
            </div>
        </div>
    </div>
