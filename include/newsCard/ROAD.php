...
<main>
    <div class="container_site">
        <h1 class="title__news">«АсАвто» - новый член РОАД</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/37bf0291ed3d93e33cc1e9cef3892b29.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Группа компаний "АсАвто" вступила в "Ассоциацию Российские Автомоибльные Дилеры" Данное решение позволит эффективнее взаимодействовать с крупнейшими автодилерами страны, органами власти и дистрибьюторами.</p>
                <p class="news__desc-text">Автобизнес в России вынужден соответствовать требованиям одновременно государственных структур, импортеров и рынка, оставаясь при этом ориентированным на удовлетворение запросов клиентов.</p>
                <p class="news__desc-text">Являясь полноправным участником РОАД, дилер может оказывать влияние как на изменение законодательства, так и на правила игры со стороны импортеров.</p>
                <p class="news__desc-text">РОАД – это эффективный инструмент, который создан специально для общения и поиска путей решения проблем.</p>
            </div>
        </div>
    </div>
