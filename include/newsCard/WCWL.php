...
<main>
    <div class="container_site">
        <h1 class="title__news">WCWL - WITH CHERY WITH LOVE!</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/photo_521.png" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Летний творческий конкурс #CheryOnTour #WithCheryWithLove для всех владельцев Chery!</p>
                <p class="news__desc-text">Два жарких летних месяца позади - на дворе уже первое августа! Представляете? Как быстро летит время!</p>
                <p class="news__desc-text">Август - последний густой бокал лета, и самый любимый месяц для отдыха у наших соотечественников. И если вы ещё не успели искупаться, позагорать, поесть арбуза и поделиться радостными летними моментами в ленте, то самое время сделать это сейчас! И отправиться в семейный тур вместе с Chery!</p>
                <p class="news__desc-text">Итак, мы запускаем наш летний творческий конкурс #CheryOnTour для всех владельцев Chery!</p>
                <p class="news__desc-text">Есть три способа принять участие в конкурсе:</p>
                <p class="news__desc-text">Выложить в ленту фото на фоне автомобиля Chery. Фотографии должны быть высокого качества. Фотография должна содержать сюжет или идею на тему путешествий или летнего отпуска, а также должна присутствовать композиция;</p>
                <p class="news__desc-text">Выложить в ленту видео на фоне автомобиля Chery. Видео должно быть высокого разрешения и должно содержать сюжет или идею на тему путешествий или летнего отпуска;</p>
                <p class="news__desc-text">В публикации надо поставить конкурсные хештеги #CheryOnTour, #WithCheryWithLove и #вТурсЧери, а также отметить наш аккаунт @chery.russia</p>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/521_wcwl2-min.png" alt="title" class="title__img">
                </div>
            </div>
        </div>
    </div>
