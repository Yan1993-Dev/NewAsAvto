...
<main>
    <div class="container_site">
        <h1 class="title__news">СТАРТ ПРОДАЖ КРОССОВЕРА CHERY TIGGO 4 В НОВЫХ КОМПЛЕКТАЦИЯХ
        ...
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/SSR_9371_in_news.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Base</p>
                <p class="news__desc-text">Кроссовер TIGGO 4 в комплектации Base предлагает потребителям электроусилитель рулевого управления, задние датчики парковки, подушки безопасности водителя и переднего пассажира, кондиционер, обогрев передних сидений, боковые зеркала с электрической регулировкой, обогревом и повторителями поворотов, четыре электростеклоподъемника, LED-ходовые огни, литые диски R16, датчики давления в шинах (TMPS) и новейшую систему курсовой устойчивости от Bosch версии 9.3, которая включает в себя антиблокировочную систему тормозов (ABS), систему динамической стабилизации (ESP), помощника при экстренном торможении (HBA), систему удержания при старте в гору (HSA), систему контроля тягового усилия (TCS) и многое другое. Автомобиль предлагается с бензиновым двигателем объемом 1.5 литра (113 л. с.) и механической пятиступенчатой коробкой передач. Максимальная рекомендованная розничная цена – 1 129 900 рублей.</p>
                <p class="news__desc-text">Comfort</p>
                <p class="news__desc-text">Автомобиль в комплектации Comfort в дополнение к Base оснащается бесключевым доступом в автомобиль и бесключевым запуском двигателя, мультифункциональным кожаным рулём, обогревом рулевого колеса, лобового стекла и форсунок стеклоомывателя, кожаным салоном, круиз-контролем, камерой заднего вида, мультимедиа с цветным 9-дюймовым емкостным сенсорным экраном, опцией «Свободные руки» (Bluetooth, Hands Free) и системой Cloudrive 2.0, позволяющей расширить возможности смартфона. Версия агрегатируется атмосферным бензиновым двигателем объемом 1.5 литра (113 л.с.) и МКПП. Максимальная рекомендованная розничная цена составляет 1 229 900 рублей, предусмотрена дополнительная выгода до 40 000 рублей по программе TRADE-IN.</p>
                <p class="news__desc-text">Luxury</p>
                <p class="news__desc-text">В комплектации Luxury покупателям, помимо оснащения Comfort, также доступен электрический стояночный тормоз с функцией AutoHold, а центральная консоль включает элементы салона верcии Cosmo. На автомобиль устанавливается двигатель объемом 1.5 литра (113 л.с.) в сочетании с вариатором. Максимальная рекомендованная розничная цена – 1 309 900 рублей. Размер выгоды по программe TRADE-IN достигает 50 000 рублей.</p>
                <p class="news__desc-text">Travel</p>
                <p class="news__desc-text">Силовой агрегат на TIGGO 4 в комплектации Travel такой же, как и в Luxury. Список оборудования включает в себя в дополнение литые 17-дюймовые диски, панорамный люк, боковые передние подушки безопасности, обогрев задних сидений, электрорегулировки водительского сидения и электропривод складывания зеркал. Максимальная рекомендованная розничная цена – 1 389 900 рублей. Выгода до 50 000 рублей доступна в рамках программы TRADE-IN.</p>
                <p class="news__desc-text">Techno</p>
                <p class="news__desc-text">В кроссовере TIGGO 4 комплектации Techno доступны стильные двухцветные литые 18-дюймовые диски, полный «зимний пакет» (обогрев передних и задних сидений, рулевого колеса, всей поверхности лобового стекла и форсунок стеклоомывателя), шесть динамиков и 7-дюймовый цветной экран с бортовым компьютером в панели приборов, а также реализована система распознавания жестов, что делает управление мультимедиа более интуитивным и позволяет повысить безопасность вождения. Жестами можно переключать аудиофайлы и радиостанции, регулировать громкость, а также управлять системой кондиционирования в салоне. Кроссовер оснащается атмосферным бензиновым двигателем объемом 2.0 литра (122 л.с.) и CVT7. Максимальная рекомендованная розничная цена – 1 419 900 рублей. При использовании программы TRADE-IN предусмотрена выгода до 50 000 рублей.</p>
                <p class="news__desc-text">Trek</p>
                <p class="news__desc-text">Новая комплектация Trek оснащается турбированным двигателем объемом 1.5 л., 147 л.с. и шестиступенчатой роботизированной коробкой передач с двумя сцеплениями DCT6. В таком автомобиле также, как и в исполнении Travel, есть панорамный люк и литые 17-дюймовые диски. Максимальная рекомендованная розничная цена составляет 1 449 900 рублей, в случае обмена автомобиля с пробегом доступна гарантированная выгода от 40 000 до 50 000 рублей.</p>
                <p class="news__desc-text">Cosmo</p>
                <p class="news__desc-text">Перечень оборудования топовой комплектации COSMO включает в себя основное оснащение комплектаций Techno и Trek (за исключением панорамного люка), и дополнено боковыми передними подушками, шторками безопасности и функцией дистанционного запуска двигателя. Максимальная рекомендованная розничная цена – 1 499 900 рублей. Выгода в размере 50 000 рублей достигается при приобретении автомобиля по программе TRADE-IN.</p>
            </div>
        </div>
    </div>
