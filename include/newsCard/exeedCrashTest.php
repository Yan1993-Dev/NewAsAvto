...
<main>
    <div class="container_site">
        <h1 class="title__news">Exeed TXL получил наивысшую оценку безопасности по итогам краш-теста</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/4f9a13446a67968fe8603fada394cd2c.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">29 августа 2020 года Китайский центр автомобильных технологий и исследований (CATARC) опубликовал результаты независимых испытаний безопасности автомобилей по методике C-NCAP, проведенных в этом году. EXEED TXL занял первое место среди всех среднеразмерных внедорожников с общим рейтингом 93,6%, тем самым получив наивысшую оценку безопасности «Пять звёзд плюс». Автомобили марки EXEED будут представлены в России под брендом EXEED.</p>
                <p class="news__desc-text">Данный результат является самым высоким показателем с момента проведения краш-тестов по новой ужесточенной программе, принятой в 2018 году. С момента введения в действие новой версии правил проведения испытаний было протестировано 56 моделей китайских, европейских, американских и других марок. Результат краш-теста EXEED TXL (93,6%) выше моделей Toyota RAV4 (90,5%), Hyundai Santa Fe (89,6%) и Audi Q5 (93,4%).</p>
                <p class="news__desc-text">Внедорожник TXL бренда EXEED значительно превысил показатели средних значений благодаря конструктивным особенностям, качеству используемых материалов при производстве кузова и сборки, а также современным электронным системам безопасности.</p>
                <p class="news__desc-text">Автомобиль набрал 96,09% в области защиты пассажиров при среднем показателе 82,9%, в тестах на оценку защиты пешеходов результат составил 75,73% при средних показателях 69,74%, в области активной безопасности был оценён максимальными 100%, что превысило на 26,21% средние значения показателей всех автомобилей.</p>
                <p class="news__desc-text">При производстве несущего кузова EXEED TXL применяется высокопрочная сталь с пределом давления 1500 мегапаскалей, что позволяет обеспечить высокую защиту пассажиров внутри автомобиля в случае фронтального, бокового или заднего удара на высокой скорости. При опрокидывании транспортного средства каркас кузова может выдержать ударную нагрузку более 10 тонн. Такие показатели позволяют модель TXL назвать капсулой безопасности.</p>
            </div>
        </div>
    </div>
