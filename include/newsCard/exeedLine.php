...
<main>
    <div class="container_site">
        <h1 class="title__news">EXEED расширяет модельную линейку</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/1409479500497ff263017c1fd6edf95e.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Компания EXEED объявляет о расширении модельного ряда марки в России до конца 2021 года. Линейка марки будет состоять из трёх автомобилей SUV-сегмента: VX, TXL и LX.</p>
                <p class="news__desc-text">«Это новая сила, которая изменит монополию традиционных премиальных автомобильных брендов!», — так охарактеризовал новую линейку продуктов бренда EXEED президент CHERY INTERNATIONAL Джанг Гоубинг.</p>
                <p class="news__desc-text">EXEED является новым игроком мирового рынка автомобилей высокого класса, он базируется на вековом опыте европейской автомобильной промышленности и интегрирует новейшие интеллектуальные технологии Китая, что даёт ему основания бросить вызов немецким и японским производителям премиум-сегмента.</p>
                <p class="news__desc-text">Внедорожники VX и TXL построены на передовой модульной платформе M3X, разработанной совместно конструкторами концерна Chery и немецкой компанией Benteler.</p>
                <p class="news__desc-text">VX относится к сегменту полноразмерных внедорожников. Габариты автомобиля составляют 4970×1940×1788 мм, колесная база достигает 2900 мм. Клиренс внедорожника VX равен 200 мм, угол въезда — 18°, угол съезда — 20°. Уверенное рулевое управление и высокий уровень плавности хода автомобилю даёт передняя независимая подвеска типа McPherson. Задняя многорычажная независимая подвеска, характерная для использования в автомобилях премиум-класса, обеспечивает превосходный комфорт, устойчивость и отличную управляемость на дороге. Объем багажного отделения равен 520 литрам.</p>
                <p class="news__desc-text">Внедорожник TXL был первой моделью бренда, представленного на российском рынке в прошлом году. Он относится к классу средне-размерных внедорожников. В модельной линейке EXEED займёт среднюю позицию при не менее впечатляющих размерах: длина составляет — 4775 мм, ширина — 1885 мм, высота — 1706 мм, колесная база равна 2800 мм.  Дорожный просвет в 210 мм в сочетании с большими углами въезда (18°) и съезда (20°) позволяет автомобилю штурмовать препятствия в виде крутых спусков, подъемов, значительных ям и бугров. Подвеска типа McPherson спереди и многорычажная независимая сзади.</p>
                <p class="news__desc-text">Кроссовер LX составит достойную конкуренцию в наиболее популярном в России сегменте компактных внедорожников. Длина кузова автомобиля равняется 4533 мм, ширина — 1848 мм, высота — 1690. Колесная база — 2650 мм. Высокий клиренс в 185 мм обеспечивает хорошую проходимость на проселочных дорогах, значительные углы въезда (18.8°) и съезда (21.6°) позволят передвигаться по холмистой местности или за городом. EXEED LX построен на проверенной модульной платформе T1X. Автомобиль также обладает высокоэффективной подвеской — спереди типа McPherson и сзади многорычажная независимая, — которая настроена на комфорт в сочетании с плавным ходом и отличной энергоемкостью.  </p>
                <p class="news__desc-text">Более подробная информация о силовых агрегатах, оснащении и ценовой политике будет представлена в следующих сериях официальных релизов марки EXEED .</p>
            </div>
        </div>
    </div>
