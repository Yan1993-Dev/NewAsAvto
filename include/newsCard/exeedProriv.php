...
<main>
    <div class="container_site">
        <h1 class="title__news">Победитель в номинации "Прорыв-Года" 2020</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/roproriv_goda.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">По результатам исследования качества автомобилей в Китае за 2019 год (2019 Initial Quality Study (IQS), обнародованной всемирно известным консалтинговым и исследовательским агентством J.D. Power, марка CHERY поднялась сразу на 26 строчек по сравнению с прошлым годом. Исследование IQS-2019 охватывает 266 моделей из 67 европейских, американских, японских и китайских брендов. </p>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/exeed-proriv.jpg" alt="title" class="title__img">
                </div>
            </div>
        </div>
    </div>
