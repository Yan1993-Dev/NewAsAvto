...
<main>
    <div class="container_site">
        <h1 class="title__news">Инновационные партнёры CHERY</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/6e0d100fff8fa5eff929b48dd75dbd5e.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Chery Holding Group заключил соглашения о стратегическом партнерстве с компаниями Haier, Horizon и дочерней компанией Alibaba Zebra Zhixing.</p>
                <p class="news__desc-text">Партнёрство с Haier основано на создании совместного предприятия Anhui Haixingyun Internet of Things Technology Co., Ltd., которое будет использовать инновационную промышленную интернет-платформу COSMOPlat с целью внедрения массовой персонализации и выстраивания новой интернет-экосистемы для автомобильной промышленности. Платформа COSMOPlat предоставляет собой креативное комплексное решение проведения исследований предпочтений потенциальных покупателей, позволяет ускорить выстраивание процесса от идеи до создания готового персонализированного продукта. Данное сотрудничество является следствием стремления компании CHERY к удовлетворению возрастающих индивидуальных запросов клиентов.</p>
                <p class="news__desc-text">Партнёрство с Haier основано на создании совместного предприятия Anhui Haixingyun Internet of Things Technology Co., Ltd., которое будет использовать инновационную промышленную интернет-платформу COSMOPlat с целью внедрения массовой персонализации и выстраивания новой интернет-экосистемы для автомобильной промышленности. Платформа COSMOPlat предоставляет собой креативное комплексное решение проведения исследований предпочтений потенциальных покупателей, позволяет ускорить выстраивание процесса от идеи до создания готового персонализированного продукта. Данное сотрудничество является следствием стремления компании CHERY к удовлетворению возрастающих индивидуальных запросов клиентов.</p>
                <p class="news__desc-text">Компания Zebra Zhixing является инновационным бизнес-сегментом Alibaba Group в автомобильной сфере. Сотрудничество с CHERY предполагает создание совместной лаборатории исследований с целью представления проектов, видений, решений будущего автомобиля с ИИ.</p>
            </div>
        </div>
    </div>
