...
<main>
    <div class="container_site">
        <h1 class="title__news">Geely Coolray новая комплектация NERO</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/wa4ta15xiaa1dwcwbdanwce0xsjp2jeu.png" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Компания Geely объявляет о выходе на российский рынок новой специальной серии кроссовера - Geely Coolray NERO, призванной подчеркнуть эксклюзивный дизайн автомобиля, благодаря элементам декора черного цвета в спортивном стиле.</p>
                <p class="news__desc-text">Следуя тенденциям в автомобильной моде и запросам потребителей, компания Geely выпустила стильную версию городского кроссовера Coolray NERO, преимущественно ориентированную на молодую аудиторию. Кузов автомобиля окрашен в фирменный цвет Ink Black – черный металлик, а корпуса боковых зеркал заднего вида получили отделку под «карбон».</p>
                <p class="news__desc-text">Кроме того, черный окрас получили 18-дюймовые легкосплавные колесные диски особого дизайна. Стильный образ подчеркивает оригинальный спортивный спойлер с характерной эмблемой в виде буквы S красного цвета. Венчают картину металлическая накладка с логотипом Coolray NERO на кромке заднего бампера и эмблема NERO на двери багажника.</p>
                <p class="news__desc-text">Кроссовер Geely Coolray NERO отличают тонированные задние стекла, а также уникальные напольные коврики в салоне автомобиля с вышивкой фирменного логотипа NERO. Новая комплектация включает в себя полностью светодиодную оптику, панорамную крышу со сдвижным люком, функции бесключевого доступа в салон и дистанционного запуска двигателя.</p>
                <p class="news__desc-text">Помимо прочего, автомобиль оснащен цифровой 7-дюймовой панелью приборов, большим многоцветным дисплеем мультимедийного комплекса диагональю 10,25 дюймов, атмосферной подсветкой интерьера, а также креслами с комбинированной спортивной отделкой. Дополнительному комфорту и безопасности способствуют системы контроля слепых зон и кругового обзора 360°.</p>
                <p class="news__desc-text">Новый Geely Coolray NERO предлагается с 1,5-литровым турбированным двигателем мощностью 150 л.с. и семиступенчатой преселективной автоматической трансмиссией с двумя «мокрыми» сцеплениями. Автомобиль можно будет приобрести в нашем дилерском центре уже в июне.</p>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/8poc93yghl1mso8brjf2p9vndveizwgp.png" alt="title" class="title__img">
                </div>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/n4l3la3ppn8pnhfvuslh81qlg82ts67g.png" alt="title" class="title__img">
                </div>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/fgqrniclv5cfmyzezop6nwmlg0fzzdmm.png" alt="title" class="title__img">
                </div>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/pbalqbkw0ffek6o97kmwb1htaywfinnf.png" alt="title" class="title__img">
                </div>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/3iirodtufv7983g4wodnoimomscfumq5.png" alt="title" class="title__img">
                </div>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/pslfkycd4blospsc2ye5ex48wlro0e7u.png" alt="title" class="title__img">
                </div>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/7zsl4a4yyvmf5x3c7akp3e9g2yknfjlo.png" alt="title" class="title__img">
                </div>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/n8grx06g3cl0m6zl2hhxxsg4irpj3szv.png" alt="title" class="title__img">
                </div>
                <div class="title__image">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/tb24ahujvr2pcs5tczzd7a2lq44nv8wn.png" alt="title" class="title__img">
                </div>
            </div>
        </div>
    </div>
