...
<main>
    <div class="container_site">
        <h1 class="title__news">Приз за тест-драйв EXEED</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/bm5fx9j7r4fndpq1p9u62cubchghyt4v.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Друзья, рады объявить о старте новой акции совместно с порталом Автомобиль Года</p>
                <p class="news__desc-text">Наступает теплый сезон, а значит – время автопутешествий!</p>
                <p class="news__desc-text">Самое время выбрать себе надежного помощника для городских и загородных поездок.</p>
                <p class="news__desc-text">Записывайтесь на тест-драйв автомобилей бренда EXEED, становитесь претендентами на призы и специальный денежный приз – 300 000 рублей!</p>
                <p class="news__desc-text">Как принять участие в акции:</p>
                <p class="news__desc-text">Перейдите по ссылке https://exeed.autogoda.ru/</p>
                <p class="news__desc-text">Выберите наш автосалон EXEED и запишитесь на тест-драйв</p>
                <p class="news__desc-text">Наш менеджер подберёт удобное Вам время для тест-драйва на выбранной модели Exeed</p>
                <p class="news__desc-text">Отметьте прохождение тест-драйва на сайте https://exeed.autogoda.ru/ до 30 июня и ждите розыгрыша призов!</p>
                <p class="news__desc-text">Каждый, кто пройдет тест-драйв одного из автомобилей EXEED и купит авто в сроки проведения акции, станет претендентом на специальный денежный приз – 300 000 рублей.</p>
                <p class="news__desc-text">Дополнительно будет розыгрыш других не менее классных подарков для всех прошедших тест - драйв в сроки проведения акции.</p>
            </div>
        </div>
    </div>
