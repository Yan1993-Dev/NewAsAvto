...
<main>
    <div class="container_site">
        <h1 class="title__news">Презентация Chery Tiggo 8 PRO MAX в ДЦ «Самара Восток»</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/e9tvb2ej7xbyxii01rjjy6jukx665sbx.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">28 апреля в нашем дилерском центре «Самара Восток» прошла презентация долгожданного CHERY TIGGO 8 PRO MAX</p>
                <p class="news__desc-text">Эту премьеру ждали многие, поэтому событие оказалось не только интересным, но и необыкновенно ярким и впечатляющим.
                    Наши клиенты смогли оценить новую модель не только визуально , но и пройти тест - драйв.
                    Мы постарались создать праздничную атмосферу для каждого гостя.</p>
                <p class="news__desc-text">Chery Tiggo 8 Pro Max — это оптимальное сочетание комфорта и безопасности.</p>
                <p class="news__desc-text">Продуманный до мельчайших деталей:</p>
                <p class="news__desc-text">Мощность 197 л/с</p>
                <p class="news__desc-text">Разгон до 100 км/ч 8.5 с</p>
                <p class="news__desc-text">Расход 8.5 л/100 км</p>
                <p class="news__desc-text">Полный привод</p>
            </div>
        </div>
    </div>
