...
<main>
    <div class="container_site">
        <h1 class="title__news">Презентация Chery Tiggo 8 PRO MAX в ДЦ «АсАвто Тольятти»</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/cherytiggopromaxDCtltl.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Презентация нового CHERY TIGGO 8 PRO MAX в «АсАвто» в г. Тольятти прошла ярко и интересно и необычно. Долгожданное событие состоялось 19 мая.</p>
                <p class="news__desc-text">Наши гости поделились впечатлениями и эмоциями после прохождения тест - драйва  и вот, что они говорят:</p>
                <p class="news__desc-text">- Комфортно</p>
                <p class="news__desc-text">- Очень быстро</p>
                <p class="news__desc-text">- Впечатляюще</p>
                <p class="news__desc-text">- Отличный дизайн</p>
                <p class="news__desc-text">Мы абсолютно с этим согласны!</p>
                <p class="news__desc-text">Интеллектуальный полный привод в TIGGO 8 PRO MAX сочетает оптимальный расход топлива и высокую проходимости!</p>
                <p class="news__desc-text">В просторном 7-местном салоне будет комфортно путешествовать всем Вашим друзьям!</p>
                <p class="news__desc-text">Во всех комплектациях Tiggo 8 PRO Max теперь установлен новейший двигатель 2.0 TGDI. Это полностью алюминиевый двигатель 3-го поколения, вес его конструкции на 50% меньше, чем у предшественника.</p>
                <p class="news__desc-text">Гарантия на автомобиль составляет 7 лет или 200 000 км пробега, в зависимости от того, что наступит ранее.</p>
                <p class="news__desc-text">Автомобиль доступен для тест- драйва в нашем  автосалоне.</p>
                <p class="news__desc-text">Запишитесь в удобное для Вас время и оцените все возможности и преимущества долгожданного  CHERY TIGGO 8 PRO MAX!</p>
            </div>
        </div>
    </div>
