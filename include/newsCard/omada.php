...
<main>
    <div class="container_site">
        <h1 class="title__news">Фан-клуб OMADA 5
        </h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/qe0segenfzsyh41jfem4j96w9f2vsww2.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Вступайте в официальную группу и фан-клуб OMODA5 в Telegram и Вас будут ждать:</p>
                <p class="news__desc-text">Уникальный контент и самая последняя информация о модели из первых рук;</p>
                <p class="news__desc-text">Конкурсы эксклюзивно для участников группы!</p>
                <p class="news__desc-text">Уже на этой неделе стартует конкурс для членов фан-клуба OMODA 5 главный приз - смартфон SAMSUNG Galaxy Note 20 8! </p>
                <p class="news__desc-text">Добро пожаловать в фан-клуб OMODA 5 <a href="https://t.me/+PYYmLRyIOgVjYmNi">https://t.me/+PYYmLRyIOgVjYmNi</a></p>
            </div>
        </div>
    </div>
