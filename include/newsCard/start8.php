...
<main>
    <div class="container_site">
        <h1 class="title__news">Старт продаж обновленного кроссовера TIGGO 8

        </h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/l43ui68q4ggqga1dqlryib3hawn6smqv.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Дистрибьютор автомобилей CHERY в России информирует о начале продаж обновленной версии кроссовера TIGGO 8. Модель уже представлена в салонах официальных дилеров в топовой комплектации PRESTIGE.</p>
                <p class="news__desc-text">Кроссовер CHERY TIGGO 8 предоставляет возможность посадки в салон до семи человек, в котором будет комфортно как водителю, так и пассажирам. В комплектацию PRESTIGE включен широкий список оснащения и оборудования: легкосплавные диски диаметром 18 дюймов, полностью светодиодная оптика, датчик света и функция отсрочки выключения фар (follow me home), кожаный салон с электрорегулировками передних сидений, полный «зимний» пакет, система кругового обзора 360° в сочетании с передними и задними датчиками парковки, круиз-контроль, датчик дождя, двухзонный климат-контроль, атмосферная подсветка интерьера, шесть подушек безопасности, электрический ручной стояночный тормоз с функцией AutoHold, дистанционный запуск двигателя, бесключевой доступ в салон, электропривод складывания зеркал и электропривод задней двери с функцией бесконтактного открывания, панорамную крышу и многое другое.</p>
                <p class="news__desc-text">В кроссовере TIGGO 8 установлена система курсовой устойчивости последнего поколения ESP версии 9.3 от Bosch, которая включает в себя функции безопасности и помощи водителю, такие как антиблокировочная система тормозов (ABS), помощник при экстренном торможении (HBA), система контроля крутящего момента (DTC), система снижения вероятности опрокидывания (RMF), электронный регулятор тормозных сил (EBD), антипробуксовочная система (TCS), система помощи при старте в гору (HHC) и система помощи при спуске с горы (HDC).</p>
                <p class="news__desc-text">Автомобиль агрегатируется бензиновым турбированным двигателем объемом 1.5 литра (147 л.c.) и шестиступенчатой роботизированной коробкой передач с двумя сцеплениями DCT6. Разгон кроссовера CHERY TIGGO 8 до 100 км/ч занимает 9,8 сек.</p>
                <p class="news__desc-text">Расход топлива в смешанном режиме не превышает 7.6 литра на 100 км, в городском — 9.8, а в загородном — 6.4. Инженеры CHERY сохранили настройки двигателя для работы на бензине с 92 октановым числом, при этом выбросы загрязняющих веществ автомобиля соответствуют требованиям пятого экологического класса.</p>
                <p class="news__desc-text">Стоимость семиместного кроссовера CHERY TIGGO 8 в комплектации PRESTIGE составляет 2 299 900 рублей, а с учётом выгод по маркетинговым программам* — 2 249 900 рублей.</p>
                <p class="news__desc-text">Программа TRADE-IN. Выгода до 50 000 рублей</p>
            </div>
        </div>
    </div>
