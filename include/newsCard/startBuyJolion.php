...
<main>
    <div class="container_site">
        <h1 class="title__news">Старт продаж Haval Jolion
        </h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/jolion.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">18.05.2021 Haval официально представил новый кроссовер - Jolion, известный на в Китае под именем Chulian («Первая любовь»). На премьере модели, которая займет место самой компактной и самой доступной в российской линейке Haval.</p>
                <p class="news__desc-text">Jolion, пришедший на смену модели H2, построен на модульной платформе L.E.M.O.N, на 70 процентов состоящей из высокопрочных сталей. Внешне он выделяется среди других моделей марки вертикальными диодными лампами дневных ходовых огней в блок-фарах. В остальном дизайн «Джолиона» схож с оформлением кроссоверов F7 и F7x, если не считать слегка пересмотренной решетки радиатора, которая в версии для России получила рисунок с горизонтальными ламелями.</p>
                <p class="news__desc-text">Базовый Jolion оснащен подогревом и электрорегулировкой зеркал заднего вида, электростеклоподъемниками и автодоводчиком двери водителя, а также рулевой колонкой с регулировкой по высоте и вылету.</p>
                <p class="news__desc-text">За доплату кроссовер можно дооснастить проекционным экраном, выводящим на лобовое стекло полезную для водителя информацию, отсеком для беспроводной зарядки гаджетов, салонным зеркалом с автозатемнением и люком на крыше. Также предлагаются электрообогрев лобового стекла и форсунок омывателя, передние и задние датчики парковки, камеры кругового обзора.</p>
                <p class="news__desc-text">Список помощников можно дополнить полностью автоматической парковкой, адаптивным круиз-контролем, системами помощи при выезде с парковки, предупреждения о столкновении, удержания в полосе движения и мониторинга «слепых» зон. Кроме этого, кроссовер умеет распознавать дорожные знаки, пешеходов и велосипедистов.</p>
                <p class="news__desc-text">Кроссовер станет первой моделью Haval в России, которой владелец сможет управлять через специальное приложение. В частности, оно позволяет удаленно блокировать и разблокировать двери и окна, включать подогрев кресел и запускать двигатель, а также следить за уровнем топлива. Программное обеспечение «Джолиона» Haval обещает обновлять тоже удаленно посредством технологии Fota (Firmware Over the Air или «обновление по воздуху»): для этого понадобится мобильная связь или Wi-Fi.</p>
                <p class="news__desc-text">Двигатель у «Джолиона» один – 1,5-литровая бензиновая «турбочетверка», развивающая 143 или 150 лошадиных сил и 210 Нм крутящего момента. А вот трансмиссию можно выбрать: это либо шестиступенчатая «механика», либо семидиапазонная роботизированная коробка DCT. Привод может быть как передним, так и полным. Производство Haval Jolion наладили на заводе марки в Тульской области в режиме полного производственного цикла.</p>
            </div>
        </div>
    </div>
