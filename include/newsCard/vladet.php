...
<main>
    <div class="container_site">
        <h1 class="title__news">Владеть CHERY TIGGO 8 PRO – выгодно. Доказано «Автостат»
        </h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/0jqm5jbv5cioz5y57kzm0cbden2yw0l4.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">По результатам исследования «Стоимость владения автомобилем», проведенного аналитическим агентством «Автостат», семиместный кроссовер CHERY TIGGO 8 PRO в своём сегменте вошёл в ТОП-3, продемонстрировав один из лучших показателей.</p>
                <p class="news__desc-text">Методика расчёта учитывает расходы владельца автомобиля, связанные с его эксплуатацией в период трёх лет и в зависимости от условий и региона: полис страхования, транспортный налог, зимние шины, техобслуживание и топливо. Также в качестве основных параметров для расчета выступили следующие: суммарный пробег – 45 000 км, возраст владельца – 35 лет, стаж вождения – 10 лет. Оценочным результатом является финальная стоимость владения автомобилем на один километр пробега.</p>
                <p class="news__desc-text">Семиместный кроссовер CHERY TIGGO 8 PRO занял достойное второе место с результатом 11,5 рублей на один километр пробега, значительно отличившись по требуемым затратам на эксплуатацию от корейских и японских конкурентов в сегменте D категории «Standart».</p>
                <table cellpadding="0" cellspacing="0" style="border-collapse: collapse;" class="uk-table">
                    <colgroup>
                        <col span="3">
                    </colgroup>
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <b><span style="color: #ff0000;">Chery </span></b>
                            </td>
                            <td>
