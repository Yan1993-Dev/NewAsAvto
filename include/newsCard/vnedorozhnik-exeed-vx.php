...
<main>
    <div class="container_site">
        <h1 class="title__news">Внедорожник EXEED VX получил наивысшую оценку безопасности по итогам краш-теста
        </h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/j0pqa1o9v10so02n6pc2h88a73jksyax.jpg" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Китайский центр автомобильных технологий и исследований (CATARC) опубликовал результаты независимых испытаний безопасности автомобилей по методике C-NCAP, проведенных в этом году. EXEED VX занял первое место среди всех семиместных среднеразмерных и полноразмерных внедорожников с общим рейтингом 92,4%, что приравнивается к оценке 5 звёзд.</p>
                <p class="news__desc-text">Высокие показатели безопасности EXEED VX были достигнуты в результате совершенствования автомобиля по итогам каждого из краш-тестов, проведенных в лаборатории безопасности R&D-центра производителя. Более 100 краш-тестов, более 1000 калибровок позволили производителю создать практически передвижную крепость, представляющую стандарт безопасности для потребителей.</p>
                <p class="news__desc-text">C-NCAP является одной из наиболее авторитетных организаций по тестированию стандартов безопасности автомобилей в Китае и регулярно пересматривает и ужесточает аспекты процедур оценки, в силу совершенствования технологий пассивной и активной безопасности автомобилей и по результатам исследований реальных сценариев дорожного движения автомобилей. </p>
                <p class="news__desc-text">EXEED VX получил наивысшую оценку 5 звёзд рейтинга безопасности и занял первое место среди всех семиместных кроссоверов и внедорожников с суммарным показателем 92,4%, что демонстрирует высокий уровень защиты пассажиров и пешеходов. Автомобиль выдержал жёсткие испытания благодаря прочной конструкции кузова и наличию множества электронных систем безопасности.</p>
                <p class="news__desc-text">В ходе проведения испытаний на лобовое столкновение и боковой удар сработали все передние и боковые подушки безопасности автомобиля, кабина осталась практически неповрежденной после удара, стойка также без значительных деформаций. За боковой удар EXEED VX получил 20 баллов, заняв первое место среди всех протестированных автомобилей с момента введения новых правил теста в 2018 году. В тесте на фронтальный удар с 40-процентным перекрытием и тесте на активную безопасность EXEED VX также финишировал с результатами, превышающими средний показатель в отрасли.</p>
                <p class="news__desc-text">Внедорожник VX является флагманской моделью технологичной автомобильной марки EXEED и уже доступен для приобретения нашем автосалоне!</p>
            </div>
        </div>
    </div>
