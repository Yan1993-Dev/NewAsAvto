...
<main>
    <div class="container_site">
        <h1 class="title__news">Great Wall Motors Wingle 7 в России</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/88877c940af2a54bbf0e8e248678f121.png" alt="title" class="title__img">
            </div>
            <div class="news__date">
                <p class="news__date-info">18.08.2021</p>
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Глобальный автомобильный концерн Great Wall Motor (GWM), которому принадлежит представленный в России бренд Haval, представляет GWM Pickup на российском рынке. Дебютной моделью станет GWM Wingle 7. Автомобили будут представлены в дилерских центрах Haval, где также будет осуществляться сервисное обслуживание.</p>
                <p class="news__desc-text">Great Wall Motor выводит на российских рынок бренд пикапов GWM Pickup. Первой моделью, которая появится в России, станет пикап GWM Wingle 7 в длиннобазной версии Comfort. Автомобили появятся в дилерских центрах Haval во второй половине октября, стоимость составит 1 749 000 рублей включая НДС.</p>
                <p class="news__desc-text">GWM WINGLE 7 – это пятиместный пикап с двухрядной кабиной, оснащенный дизельным турбированным двигателем объемом 2 литра и мощностью 143 л.с., шестиступенчатой механической коробкой передач, а также системой полного привода с раздаточной коробкой Borg Warner и понижающей передачей, оборудованной принудительной блокировкой заднего дифференциала, что обеспечивает высокую проходимость при эксплуатации в различных условиях. Вместительность пикапа GWM Wingle 7 достигается благодаря внушительному размеру грузовой платформы: длина – 1680 мм, ширина – 1460 мм, высота – 480 мм.</p>
                <p class="news__desc-text">ЭКСТЕРЬЕР нового пикапа GWM Wingle 7 отличают 16-дюймовые алюминиевые колесные диски, массивная хромированная решетка радиатора и светодиодные дневные ходовые огни, интегрированные в нижний бампер. Зеркала заднего вида оборудованы электроприводом и обогревом. Особое внимание уделено защитным покрытиям автомобиля, в число которых входят усиленное антикоррозийное покрытие днища, противоскользящее и антивандальное напыление грузового отсека, а также защитное внутреннее покрытие кузова (пола, бортов, колесных арок).</p>
                <p class="news__desc-text">ИНТЕРЬЕР пикапа GWM Wingle 7 сочетает в себе функциональность и современные опции комфорта водителя и пассажиров. Многофункциональный руль имеет кожаную отделку, на нем расположены кнопки управления мультимедийной системой, Bluetooth и круиз-контролем. В автомобиле есть возможность механической регулировки сидений водителя по высоте в 6 направлениях и пассажира в 4 направлениях.</p>
            </div>
        </div>
    </div>
