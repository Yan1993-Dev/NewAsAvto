    ...
    <div class="container_site">
        ...
        <div>
            ...
            <div class="news__desc">
                <p class="news__desc-text">Авторассрочка на Chery и EXEED возвращается!</p>
                <p class="news__desc-text">Действует на все модели автомобилей Chery и EXEED.</p>
                <p class="news__desc-text">Ставка банка 0%. Переплата по процентной ставке отсутствует.</p>
                <p class="news__desc-text">Первоначальный взнос: от 0 руб. Вы можете оформить Авторассрочку даже без первого взноса, либо внести сумму, которая будет Вам комфортна.</p>
                <p class="news__desc-text">Базовый срок равен 12 месяцам. Размер всех платежей одинаковый.</p>
                <p class="news__desc-text">Возможно продление срока до 18 месяцев. Продление можно подключить в мобильном приложении банка.</p>
                <p class="news__desc-text">Доступно частичное и полное досрочное погашение Авторассрочки.</p>
                <p class="news__desc-text">Возраст Клиента от 20 до 75 лет (на момент оформления рассрочки).</p>
                <p class="news__desc-text">Официальное трудоустройство (стаж на последнем месте работы не менее 4 месяцев).</p>
                <p class="news__desc-text">Наличие постоянной регистрации не менее 4 последних месяцев на территории одного населенного пункта РФ.</p>
                <p class="news__desc-text">ДЛЯ ОФОРМЛЕНИЯ РАССРОЧКИ ДОСТАТОЧНО ТОЛЬКО ПАСПОРТА РФ!</p>
                <p class="news__desc-text">Банк-партнёр: программы: "Совком Банк"</p>
                <p class="news__desc-text">Неоспоримым преимуществом программы является практически полное отсутствие переплаты, а также возможность приобрести а/м без первого взноса. Идеально подойдёт для тех, кто хочет сэкономить на процентной ставке банка и готов вносить относительно большие ежемесячные платежи.</p>
            </div>
        </div>
    </div>
