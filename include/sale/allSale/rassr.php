    ...
    <div class="container_site">
        ...
        <div>
            ...
            <div class="news__desc sale__desc autorassr_sale">
                ...
                <p class="sale__text">Действует на все модели автомобилей Chery и EXEED.</p>
                ...
                <p class="sale__text">Наличие постоянной регистрации не менее 4 последних месяцев на территории одного населенного пункта РФ.</p>
                <p class="news__desc sale__text contur__title">ДЛЯ ОФОРМЛЕНИЯ РАССРОЧКИ ДОСТАТОЧНО ТОЛЬКО ПАСПОРТА РФ!</p>
            </div>
            <div class="wrap__seo">
                <p class="seo__text__afterTable">Банк-партнёр: программы: "Совком Банк"</p>
                <p class="seo__text__afterTable">Неоспоримым преимуществом программы является практически полное отсутствие переплаты, а также возможность приобрести а/м без первого взноса. Идеально подойдёт для тех, кто хочет сэкономить на процентной ставке банка и готов вносить относительно большие ежемесячные платежи.</p>
            </div>
        </div>
    </div>
