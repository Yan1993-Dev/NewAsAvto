...
<main>
    <div class="container_site">
        <h1 class="title__news">Chery Помощь на дорогах</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/1f691651762f7744188bb07ba950bdec.jpg" alt="title" class="title__img">
            </div>
            <div class="news__desc sale__text">
                <p class="sale__text">Программа «Chery — помощь в пути» предназначена для обращения владельцев карт за услугами технической помощи и справочно-юридическими консультациями.</p>
                <p class="sale__text">Горячая линия «Chery — помощь в пути» - 8-800-555-998-9.</p>
                <p class="sale__text ">Программа технической поддержки клиентов «Chery — помощь в пути» разработана ЗАО «Чери Автомобили Рус» в сотрудничестве с Российским Автомобильным Товариществом — РАТ.</p>
                <p class="sale__text contur__title">ЦЕЛЬЮ ПРОГРАММЫ ЯВЛЯЕТСЯ:</p>
                <p class="sale__text sale__arr">Круглосуточное оказание экстренной помощи на дороге владельцам карты</p>
                <p class="sale__text sale__arr">«Chery — помощь в пути», используя технические возможности и навыки сотрудников РАТ</p>
                <p class="sale__text sale__arr">Оказание оперативной информационно-правовой помощи, консультирование</p>
                <p class="sale__text sale__arr">Оперативное представление информации о продукции компании Chery</p>
                <p class="sale__text sale__arr">Количество обращений не ограничено в пределах срока действия карты</p>
                <p class="sale__text contur__title">ПРИ ВЫЗОВЕ МАШИНЫ ТЕХНИЧЕСКОЙ ПОМОЩИ:</p>
                <p class="sale__text sale__arr">Запуск двигателя автомобиля от внешнего источника</p>
                <p class="sale__text  sale__arr">Отключение сигнализации</p>
                <p class="sale__text sale__arr">Очистка зажима аккумуляторной батареи</p>
                <p class="sale__text sale__arr">Ремонт шин (бескамерных, с проколом)</p>
                <p class="sale__text sale__arr">Замена колеса на запасное</p>
                <p class="sale__text sale__arr">Подкачка шин</p>
                <p class="sale__text sale__arr">Работы с потайными и сорванными болтами</p>
                <p class="sale__text sale__arr">Заправка топливом</p>
                <p class="sale__text sale__arr">Разблокировка замка зажигания</p>
                <p class="sale__text sale__arr">Вскрытие крышки багажника, капота, дверей автомобиля</p>
                <p class="sale__text sale__arr">Блокировка трансмиссии (замки на руль управления и педали)</p>
            </div>
            <div class="wrap__seo">
                <p class="seo__text__afterTable">В случае невозможности исправления поломки на месте, автомобиль будет эвакуирован в ближайший Дилерский центр Chery.Программа «Chery — помощь в пути» рассчитана как на нынешних владельцев автомобилей Chery, приобретенных у официальных дилеров Chery, так и на будущих клиентов. Подробную информацию о Программе технической поддержки «Chery — помощь в пути» вы можете получить в любом официальном Дилерском центре CHERY.</p>
                <p class="seo__text__afterTable">Услуги по карте «Chery — помощь в пути» действуют в течении года с момента активации карты. Услуги оказываются в случае поломки/ДТП с участием автомобиля.</p>
                </div>
        </div>
    </div>
