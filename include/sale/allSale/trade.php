    ...
    <div class="container_site">
        ...
        <div>
            ...
            <div class="news__desc">
                <p class="news__desc-text">Выгодные условия покупки автомобиля по программе TRADE-IN.</p>
                <p class="news__desc-text">Быстро и удобно обменять Ваш текущий автомобиль на новый кроссовер - что может быть проще?</p>
                <p class="news__desc-text">Всего 5 шагов и задача выполнена:</p>
                <p class="news__desc-text">Выберите новый автомобиль</p>
                <p class="news__desc-text">Предоставьте Ваш текущий автомобиль нам на осмотр и оценку. Процесс занимает около 30 минут. Наша оценка Вашего автомобиля будет выше его рыночной стоимости. Оценочную стоимость Вашего автомобиля Вы можете использовать как первоначальный взнос по автокредиту. Если Вы ещё не выплатили кредит за Ваш текущий автомобиль - ничего страшного, мы сделаем это за Вас!</p>
                <p class="news__desc-text">Мы подготовим все необходимые для оформления сделки документы. Вы получаете безопасную и честную сделку.</p>
                <p class="news__desc-text">Мы сделаем скидку на новый автомобиль, что даст Вам дополнительную выгоду. Мы подготовим все необходимы документы.</p>
                <p class="news__desc-text">Оставьте Ваш старый автомобиль у нас в автосалоне и уезжайте на новом Chery! Очередное преимущество в том, что Вы не остаётесь без автомобиля ни на минуту.</p>
                <p class="news__desc-text">Скидки по программе Trade-in суммируются с акциями и скидками по другим действующим программам.</p>
            </div>
        </div>
    </div>
