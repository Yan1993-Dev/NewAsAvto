...
<main>
    <div class="container_site">
        <h1 class="title__news">Кредит без первого взноса</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/4cf6a20f5f6d76ccb2bb8e03890e2b3e.jpg" alt="title" class="title__img">
            </div>
            <div class="news__desc sale__text">
                <p class="sale__text">Выгодные условия покупки автомобиля по программе TRADE-IN.</p>
                <p class="sale__text">Быстро и удобно обменять Ваш текущий автомобиль на новый кроссовер - что может быть проще?</p>
                <p class="sale__text contur__title">Всего 5 шагов и задача выполнена:</p>
                <p class="sale__text sale__arr">Выберите новый автомобиль</p>
                <p class="sale__text sale__arr">Предоставьте Ваш текущий автомобиль нам на осмотр и оценку. Процесс занимает около 30 минут. Наша оценка Вашего автомобиля будет выше его рыночной стоимости. Оценочную стоимость Вашего автомобиля Вы можете использовать как первоначальный взнос по автокредиту. Если Вы ещё не выплатили кредит за Ваш текущий автомобиль - ничего страшного, мы сделаем это за Вас!</p>
                <p class="sale__text sale__arr">Мы подготовим все необходимые для оформления сделки документы. Вы получаете безопасную и честную сделку.</p>
                <p class="sale__text sale__arr">Мы сделаем скидку на новый автомобиль, что даст Вам дополнительную выгоду. Мы подготовим все необходимы документы.</p>
                <p class="sale__text sale__arr">Оставьте Ваш старый автомобиль у нас в автосалоне и уезжайте на новом Chery! Очередное преимущество в том, что Вы не остаётесь без автомобиля ни на минуту.</p>
                <p class="sale__text">Скидки по программе Trade-in суммируются с акциями и скидками по другим действующим программам.</p>
            </div>
        </div>
    </div>
