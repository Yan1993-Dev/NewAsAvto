...
<main>
    <div class="container_site">
        <h1 class="title__news">Скидка 14% для а/м от 3-х до 5-ти лет</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/8l69omwvk0rfpeizni5b9rgrcsf7d34j.jpg" alt="title" class="title__img">
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Возраст Вашего автомобиля от 3 до 5 лет?</p>
                <p class="news__desc-text">Отличные новости для Вас!</p>
                <p class="news__desc-text">Для Вас действует скидка 14% на автоработы в наших Сервисных центрах</p>
            </div>
        </div>
    </div>
