...
<main>
    <div class="container_site">
        <h1 class="title__news">Скидка 34% для а/м старше 5-ти лет</h1>
        <div>
            <div class="title__image">
                <img src="<?= SITE_TEMPLATE_PATH ?>/static/images/4soydsazo4kjsfbrgtugouiwrserckx2.jpg" alt="title" class="title__img">
            </div>
            <div class="news__desc">
                <p class="news__desc-text">Возраст Вашего автомобиля старше 5 лет?</p>
                <p class="news__desc-text">Отличные новости для Вас!</p>
                <p class="news__desc-text">Для Вас действует скидка 34% на автоработы в наших Сервисных центрах</p>
            </div>
        </div>
    </div>
