...
<head>
    ...
    <title>Ошибка. Страницу не существует или удалена. Перейти на Главную страницу сайта.</title>
</head>
<body>
    <div class="container_site">
        <header class="header">
            <button class="header__mobile_btn">
                    ...
                    <div class="mobile__header__container">
                        <nav class="nav__mobile">
                            ...
                            <div class="mobile__desc">
                                <a href="tel:+7(8846)215-00-07" class="phone__mobile"><img src="<?=SITE_TEMPLATE_PATH?>/static/icons/phoneMobile.svg" alt="" class="phone__icon">8 (846) 215 00 07</a>
                            <a href="#" class="mob__phone"><p class="mob__text">Заказать звонок</p></a>
                ...
                <div class="wrapper__phone">
                    <a href="tel:+7(8846)215-00-07" class="phone"><img src="<?=SITE_TEMPLATE_PATH?>/static/icons/phone.svg" alt="phone" class="phone__icon">8 (846) 215 00 07</a>
        ...
        <div class="container_site">
            <div class="title">
                <h1 class="text__title" id="calculator">Что то пошло не так...</h1>
            </div>
            <div class="desc__inner">
                <p class="desc">Запрошенная Вами страница не найдена. Возможно, мы удалили или
                    переместили ее. Вы можете перейти на <a href="../index.html" class="back__to__main">главную страницу</a></p>
            </div>
        </div>
        <section class="map">
            <div class="container">
            ...
            <div class="container_site">
                <div class="wrapper__footer">
                    <div class="footer__logo_container">
                        <a class="footer__logo" href="../index.html"><img src="<?=SITE_TEMPLATE_PATH?>/static/images/logo.png" alt="company_logo" class="footer__logo"></a>
                    </div>
...
<script src="<?=SITE_TEMPLATE_PATH?>/script/changeModel.js"></script>
<script src="<?=SITE_TEMPLATE_PATH?>/script/burger.js"></script>
<script src="<?=SITE_TEMPLATE_PATH?>/script/button__up.js"></script>
<script src="<?=SITE_TEMPLATE_PATH?>/script/popup.js"></script>
