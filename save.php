...
if ($_POST) { 
	...
	if(isset($_POST['select-tradein'])) 
		$inputText['Программа Trade-in'] = htmlspecialchars($_POST["select-tradein"]);
    if(isset($_POST['td-model'])) 
		$inputText['Программа Trade-in'] = htmlspecialchars($_POST["td-model"]);
    ...
    if(isset($_POST['datepicker'])) 
        $inputText['День перезвона'] = htmlspecialchars($_POST["datepicker"]);
    ...
    if(isset($_POST['time-picker'])) 
        $inputText['Время ТО'] = htmlspecialchars($_POST["time-picker"]);
